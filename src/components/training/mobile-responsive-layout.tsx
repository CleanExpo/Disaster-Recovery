    ...
    >
              ...
              {Array.from({ length: totalDays }, (_, i) => i + 1).map((day, index) => (
                ...
                >
                  ...
                  <span className="flex items-center relative z-10">
                    <div className={cn(
                      "w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold mr-3 transition-colours",
                      day === currentDay 
      ...
      <div className="hidden lg:flex items-center justify-between px-8 py-4 bg-white border-t border-gray-200">
        <button
          ...
          disabled={currentDay === 1}
          className={cn(
            "flex items-center px-6 py-3 rounded-lg font-medium transition-colours",
            currentDay === 1 
              ? "bg-gray-100 text-gray-400 cursor-not-allowed" 
              : "bg-white border border-gray-300 text-gray-700 hover:bg-gray-50"
          )}
