...
const ComplianceMonitoringDashboard: React.FC<ComplianceMonitoringDashboardProps> = ({
  ...
  const getRiskLevelLabel = (score: number) => {
    ...
    if (score <= 50) return { label: 'Medium Risk', color: 'text-yellow-600 bg-yellow-50' };
    if (score <= 75) return { label: 'High Risk', color: 'text-orange-600 bg-orange-50' };
    return { label: 'Critical Risk', color: 'text-red-600 bg-red-50' };
  };
        ...
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="grid grid-cols-2 gap-4">
            <div className="text-center">
              ...
              <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium mt-1 ${getRiskLevelLabel(dashboard.riskScore).color}`}>
