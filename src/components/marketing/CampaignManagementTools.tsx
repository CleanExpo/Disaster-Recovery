...
export default function CampaignManagementTools() {
  ...
  const mockCampaigns: ManagedCampaign[] = [
    ...
    {
      id: '3',
      name: 'Mold Awareness Social Campaign',
      description: 'Educational campaign about mold risks and professional remediation services.',
      type: 'awareness',
      status: 'paused',
      ...
      assets: [
        {
          id: '4',
          type: 'video',
          name: 'Mold Health Risks Educational Video',
          url: '/assets/mold-education.mp4',
          platform: 'facebook',
          status: 'approved',
