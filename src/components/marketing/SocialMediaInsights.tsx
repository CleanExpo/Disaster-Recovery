        ...
        content: [
          {
            id: 'ig-post-1',
            type: 'reel',
            content: '60-second transformation: Mold remediation process from start to finish. Swipe to see the amazing results! #MoldRemediation #TransformationTuesday #HealthyHomes',
            media: [
              { type: 'video', url: '/social/mold-remediation-reel.mp4', alt: 'Mold remediation time-lapse' }
            ],
