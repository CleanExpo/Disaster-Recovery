            ...
            <div className="lg:col-span-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  {[
                    { icon: Facebook, href: "https://facebook.com/DisasterRecoveryAustralia", color: "hover:text-blue-500" },
                    { icon: Instagram, href: "https://instagram.com/disasterrecoveryau", color: "hover:text-pink-500" },
                    { icon: Youtube, href: "https://youtube.com/c/DisasterRecoveryAustralia", color: "hover:text-red-500" },
                    { icon: Linkedin, href: "https://linkedin.com/company/disaster-recovery-australia", color: "hover:text-blue-400" },
                    { icon: Twitter, href: "https://twitter.com/DisasterRecovAU", color: "hover:text-blue-400" }
                  ].map(({ icon: Icon, href, color }, index) => (
                    <a key={index} href={href} target="_blank" rel="noopener noreferrer" 
                       className={`p-2 bg-gray-700 rounded-lg transition-all duration-300 ${color} hover:scale-110`}>
            ...
            <div className="lg:col-span-3">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={location.city} className="flex items-center justify-between p-3 bg-gray-800 rounded-lg hover:bg-gray-700 transition-colors">
                    <div>
              ...
              <div className="space-y-2">
                ...
                {[
                  ...
                  <FooterLink key={resource.name} href={resource.href} 
                             className="flex items-center gap-3 p-2 hover:bg-gray-800 rounded transition-colors">
          ...
          <div className="container px-4 sm:px-6 lg:px-8 py-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
                  {INSURANCE_PARTNERS.slice(0, 12).map((partner, index) => (
                    <div key={index} className="p-2 bg-gray-700 rounded text-center hover:bg-gray-600 transition-colors">
                      <div className="text-xs font-medium">{partner}</div>
                    </div>
                  ))}
                </div>
                <FooterLink href="/insurance" className="block mt-3 text-center p-2 bg-blue-600 hover:bg-blue-700 rounded font-medium transition-colors">
              ...
              <div>
                ...
                <div className="space-y-2">
                  <FooterLink href="/privacy" className="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded transition-colors">
                    Privacy Policy
                    <ExternalLink className="h-4 w-4" />
                  </FooterLink>
                  <FooterLink href="/terms" className="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded transition-colors">
                    Terms of Service
                    <ExternalLink className="h-4 w-4" />
                  </FooterLink>
                  <FooterLink href="/complaints" className="flex items-center justify-between p-3 bg-gray-700 hover:bg-gray-600 rounded transition-colors">
