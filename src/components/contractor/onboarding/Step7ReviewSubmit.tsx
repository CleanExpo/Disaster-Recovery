...
const reviewSchema = z.object({
  ...
  confirmPaymentAuthorized: z.boolean().refine(val => val === true, {
    message: "You must authorize the payment"
  }),
  ...
  const reviewSections: SectionReview[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Specialized Equipment', value: applicationData.equipment?.specializedEquipment?.length ? `${applicationData.equipment.specializedEquipment.length} items` : 'Not provided', required: true },
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-start space-x-3 space-y-0">
                      ...
                      <div className="space-y-1 leading-none">
                        <FormLabel>
                          I authorize the payment of $275.00 application fee
                        </FormLabel>
                        <FormDescription>
