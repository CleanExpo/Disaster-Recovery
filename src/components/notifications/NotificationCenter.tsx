      ...
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        <SheetTrigger asChild>
          <Button variant="ghost" size="icon" className="relative">
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 text-white text-xs rounded-full flex items-centre justify-centre">
        ...
        <SheetContent className="w-[400px] sm:w-[540px] p-0">
          <SheetHeader className="border-b px-6 py-4">
            <div className="flex items-centre justify-between">
              <SheetTitle className="flex items-centre gap-2">
                <Bell className="h-5 w-5" />
                Notifications
              </SheetTitle>
          ...
          <ScrollArea className="h-[calc(100vh-180px)]">
            {filteredNotifications.length > 0 ? (
              ...
              <div className="flex flex-col items-centre justify-centre py-12 text-gray-500">
