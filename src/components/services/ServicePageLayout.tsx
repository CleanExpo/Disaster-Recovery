// Service Page Layout Component with SEO Optimization
          ...
          <aside className="space-y-8">
            ...
            <div className="bg-emergency-50 border-2 border-emergency-200 rounded-2xl p-8">
              ...
              <a
                ...
                className="block w-full bg-emergency-600 text-white text-center py-4 rounded-lg font-bold text-lg hover:bg-emergency-700 transition-colors"
              >
                Call 1-800-DISASTER
              </a>
              <Link
                href="/emergency-form"
                className="block w-full mt-4 bg-white text-emergency-600 text-center py-4 rounded-lg font-bold border-2 border-emergency-600 hover:bg-emergency-50 transition-colors"
              >
              ...
              <div className="space-y-4">
                {relatedServices.map((service, index) => (
                  <Link
                    key={index}
                    href={service.href}
                    className="flex items-center p-3 rounded-lg hover:bg-neutral-50 transition-colors group"
                  >
            ...
            <div className="space-y-6">
              {faqs.map((faq, index) => (
                <details key={index} className="bg-white rounded-lg shadow-md group">
                  <summary className="px-6 py-4 cursor-pointer list-none flex justify-between items-center font-semibold text-neutral-900 hover:text-primary-600 transition-colors">
                    {faq.question}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              Call Now: 1-800-DISASTER
            </a>
            <Link
              href="/get-quote"
              className="inline-flex items-center justify-center px-8 py-4 bg-primary-800 text-white rounded-lg font-bold text-lg hover:bg-primary-900 transition-colors"
            >
              Get Free Assessment
            </Link>
          </div>
