...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-centre justify-centre overflow-hidden bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-centre">
        {/* Emergency badge */}
        <div className="inline-flex items-centre gap-2 mb-8 px-4 py-2 bg-red-500/10 border border-red-500/30 rounded-full animate-pulse">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-centre mb-16">
          ...
          <Link
            href="/quote"
            className="group relative inline-flex items-centre justify-centre gap-3 px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full text-white font-semibold text-lg transition-all hover:bg-white/20 hover:scale-105"
          >
        ...
        {/* Trust indicators */}
        <div className="flex flex-wrap justify-centre gap-8 items-centre">
          {features.map((feature, index) => (
            <div
              key={index}
              className="flex items-centre gap-3 px-6 py-3 bg-white/5 backdrop-blur-sm rounded-full border border-white/10"
            >
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
          <div className="w-8 h-12 border-2 border-white/20 rounded-full flex justify-centre">
