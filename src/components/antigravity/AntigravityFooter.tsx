    ...
    <footer className="ag-site-footer">
      <div className="ag-container ag-footer-grid">
        ...
        <div className="ag-footer-brand">
          ...
          <div className="ag-footer-social">
            ...
            <a
              href="https://youtube.com/@DisasterRecoveryAU"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="YouTube"
            >
            ...
            <a
              href="https://linkedin.com/company/disaster-recovery-au"
              target="_blank"
              rel="noopener noreferrer"
              aria-label="LinkedIn"
            >
        ...
        {/* Company column */}
        <nav className="ag-footer-nav" aria-label="Company links">
          <h4>Company</h4>
        ...
        {/* Services column */}
        <nav className="ag-footer-nav" aria-label="Services links">
          <h4>Services</h4>
        ...
        {/* Locations column */}
        <nav className="ag-footer-nav" aria-label="Locations links">
      ...
      <div className="ag-footer-bottom ag-container">
        <div className="ag-copyright">
          &copy; {currentYear} Disaster Recovery. All rights reserved. Powered by National
          Restoration Professionals Group (NRPG).
        </div>
        <nav className="ag-legal-links" aria-label="Legal links">
