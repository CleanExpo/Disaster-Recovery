...
const services: ServiceCardProps[] = [
  {
    ...
    description:
      'Rapid water extraction, structural drying, and complete restoration to prevent secondary damage and mould growth.',
  ...
  },
  {
    ...
    description:
      'Complete fire damage restoration including smoke odour removal, soot cleaning, and structural repairs.',
  ...
  },
  {
    ...
    description:
      'Professional mould removal and prevention using IICRC certified techniques to ensure a healthy environment.',
  ...
  },
  {
    ...
    description:
      'Comprehensive storm damage recovery including emergency tarping, water extraction, and full restoration.',
  ...
  },
  {
    ...
    description:
      'Sensitive and professional cleanup of biohazardous materials following strict safety protocols.',
  ...
  },
  {
    ...
    description:
      'Large-scale disaster recovery for businesses, minimising downtime and revenue loss.',
...
export default function PremiumServicesGrid({
  ...
  const [selectedCategory, setSelectedCategory] = useState<ServiceCardProps['category'] | 'all'>(
    'all',
  );
          ...
          <>
            ...
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                From emergency water extraction to complete fire restoration, our expert team
                delivers comprehensive solutions with cutting-edge equipment and proven techniques.
              </p>
            </div>
              ...
              <div className="flex flex-wrap justify-center gap-3 mb-12">
                {categories.map((category) => (
                  <button
                    key={category.id}
                    onClick={() =>
                      setSelectedCategory(category.id as ServiceCardProps['category'] | 'all')
                    }
                    className={cn(
