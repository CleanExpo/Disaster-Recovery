...
export const metadata: Metadata = {
  ...
  description: 'Emergency disaster recovery services available 12AM - 6AM. No call-out fees, immediate response across Australia.',
};
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-r from-red-900 to-orange-800 text-white py-20">
        <div className="container mx-auto px-4 text-centre">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Midnight Emergency Services</h1>
