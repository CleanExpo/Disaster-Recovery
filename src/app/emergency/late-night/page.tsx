...
export const metadata: Metadata = {
  ...
  description: 'Emergency disaster recovery services available 10PM - 2AM. No call-out fees, immediate response across Australia.',
};
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-r from-red-900 to-orange-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Late Night Emergency Services</h1>
          <p className="text-xl mb-2">Available 10PM - 2AM</p>
