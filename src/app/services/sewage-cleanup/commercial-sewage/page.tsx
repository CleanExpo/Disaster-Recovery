...
export default function CommercialSewageCleanupPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Commercial Sewage Cleanup',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert commercial sewage cleanup services, Disaster Recovery QLD provides comprehensive solutions 
