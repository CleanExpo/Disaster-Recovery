...
export default function BathroomMouldRemediationPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Bathroom Mould Remediation',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert bathroom mould remediation services, Disaster Recovery QLD provides comprehensive solutions 
