...
export default function SootDamageCleaningPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Soot Damage Cleaning',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert soot damage cleaning services, Disaster Recovery QLD provides comprehensive solutions 
