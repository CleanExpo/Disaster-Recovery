...
export const metadata: Metadata = {
  ...
  description: 'Expert fire and smoke damage restoration services following IICRC S700 standards. Soot removal, smoke odor elimination, structural fire damage repair. 24/7 emergency response nationwide.',
  keywords: [
...
const faqs = [
  ...
  {
    question: "How do you remove smoke odors permanently?",
    answer: "We use multiple proven methods including thermal fogging, ozone treatment, hydroxyl generators, and specialized cleaning agents. The method depends on the type of smoke damage and affected materials, following IICRC S700 protocols."
  },
  {
  ...
  },
  {
    ...
    answer: "Yes, we provide contents restoration services using specialized cleaning techniques, ultrasonic cleaning, and controlled atmosphere drying. Items are assessed individually, and we can often restore items that appear beyond repair."
  },
  {
...
export default function FireDamagePage() {
  return (
    <ServicePageLayout
      ...
      description="Expert fire and smoke damage restoration services following IICRC S700 standards. Professional soot removal, smoke odor elimination, and complete structural fire damage repair with 24/7 emergency response."
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="relative">
            <SEOImage
              ...
              alt="Professional thermal fogging equipment for smoke odor elimination"
              width={500}
              height={400}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-neutral-200 rounded-xl p-6 shadow-sm">
              ...
              <p className="text-neutral-700 mb-4">
                High-output ozone generators for severe smoke odor elimination. These industrial units break down 
                odor-causing compounds at the molecular level for permanent odor removal.
              </p>
              <div className="flex items-center text-sm text-primary-600 font-medium">
                <svg className="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-gradient-to-br from-neutral-50 to-gray-50 border border-neutral-200 rounded-xl p-6">
            ...
            <p className="text-neutral-700 text-sm">
              Specialized cleaning and deodorization for properties affected by smoke without direct fire damage, 
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 border border-green-200 rounded-xl p-6">
            ...
            <p className="text-neutral-700 text-sm">
              Specialized restoration for properties affected by bushfires including ember damage, radiant heat 
          ...
          <div className="bg-gradient-to-br from-blue-50 to-sky-50 border border-blue-200 rounded-xl p-6">
            ...
            <p className="text-neutral-700 text-sm">
              Specialized handling and restoration of properties affected by chemical fires requiring HAZMAT 
              protocols and specialized cleaning agents.
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 border border-yellow-200 rounded-xl p-6">
            ...
            <p className="text-neutral-700 text-sm">
              Complete restoration including electrical system assessment and repair, specialized cleaning of 
          ...
          <div className="bg-gradient-to-br from-purple-50 to-violet-50 border border-purple-200 rounded-xl p-6">
            ...
            <p className="text-neutral-700 text-sm">
              Specialized restoration of personal belongings, furniture, electronics, documents, and artwork 
      ...
      <section className="bg-gradient-to-r from-emergency-500 to-emergency-600 rounded-2xl p-8 text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <a
            ...
            className="inline-flex items-center justify-center px-8 py-4 bg-white text-emergency-600 rounded-lg font-bold text-lg hover:bg-emergency-50 transition-colors"
          >
            <svg className="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            Emergency: 1-800-DISASTER
          </a>
          <Link
            href="/emergency-form"
