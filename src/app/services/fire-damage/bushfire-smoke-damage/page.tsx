...
export default function BushfireSmokeDamagePage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Bushfire Smoke Damage',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert bushfire smoke damage services, Disaster Recovery QLD provides comprehensive solutions 
