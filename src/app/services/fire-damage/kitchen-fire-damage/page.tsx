...
export default function KitchenFireDamageRestorationPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Kitchen Fire Damage Restoration',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert kitchen fire damage restoration services, Disaster Recovery QLD provides comprehensive solutions 
