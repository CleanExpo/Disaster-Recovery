...
export default function RestaurantWaterDamagePage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Restaurant Water Damage',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert restaurant water damage services, Disaster Recovery QLD provides comprehensive solutions 
