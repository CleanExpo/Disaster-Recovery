...
export default function FactoryFloodRecoveryPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Factory Flood Recovery',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert factory flood recovery services, Disaster Recovery QLD provides comprehensive solutions 
