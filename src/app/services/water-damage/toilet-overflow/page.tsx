...
export default function ToiletOverflowCleanupPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Toilet Overflow Cleanup',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert toilet overflow cleanup services, Disaster Recovery QLD provides comprehensive solutions 
