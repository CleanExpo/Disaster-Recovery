...
export default function RoofLeakWaterDamagePage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Roof Leak Water Damage',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert roof leak water damage services, Disaster Recovery QLD provides comprehensive solutions 
