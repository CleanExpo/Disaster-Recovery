...
export default function IpswichFloodRecoveryPage() {
  ...
  const businessInfo = {
    name: 'Disaster Recovery QLD - Ipswich Flood Recovery',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-700 mb-8">
              When you need expert ipswich flood recovery services, Disaster Recovery QLD provides comprehensive solutions 
