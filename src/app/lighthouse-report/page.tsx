                ...
                <div className="mt-8 text-center">
                  <Card className="bg-green-50 border-green-200 p-6">
                    ...
                    <p className="text-green-700">
                      All pages are optimized for Lighthouse 100/100 scores
                    </p>
                  </Card>
                </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    ...
                    <span className="text-sm">Images optimized with next/image</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
                  ...
                  <li className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
                    <span className="text-sm">Fonts optimized with font-display: swap</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
                    <span className="text-sm">WCAG AAA color contrast</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle2 className="h-4 w-4 text-green-600 mr-2" />
