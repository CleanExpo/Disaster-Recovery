                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {[
                        { value: 'emergency', label: 'Emergency', color: 'red', icon: <AlertTriangle /> },
                        { value: 'urgent', label: 'Urgent', color: 'orange', icon: <Clock /> },
                        { value: 'routine', label: 'Routine', color: 'blue', icon: <Calendar /> },
                        { value: 'planning', label: 'Planning', color: 'gray', icon: <FileText /> }
                      ].map((urgency) => (
                        <button
                          key={urgency.value}
                          type="button"
