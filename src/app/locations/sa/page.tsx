...
export const metadata: Metadata = {
  ...
  description: 'Leading disaster recovery services across South Australia. Emergency response for Bushfires, Heatwaves, Flooding, Severe Storms. Serving Adelaide, Mount Gambier, Whyalla, Murray Bridge and all SA regions. Call 1300 DISASTER.',
  keywords: [
