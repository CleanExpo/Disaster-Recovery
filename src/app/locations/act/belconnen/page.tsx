...
export default function BelconnenPage() {
  return (
    <div className="min-h-screen p-8">
      <h1 className="text-4xl font-bold mb-6">Disaster Recovery Belconnen</h1>
      <p className="text-xl">24/7 Emergency Services in Belconnen, Australian Capital Territory</p>
    </div>
  );
}