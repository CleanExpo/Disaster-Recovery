...
export const metadata: Metadata = {
  ...
  description: 'Leading disaster recovery services across Northern Territory. Emergency response for Cyclones, Flooding, Bushfires, Extreme Heat. Serving Darwin, Palmerston, Alice Springs, Katherine and all NT regions. Call 1300 DISASTER.',
  keywords: [
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8">
              24/7 Emergency Response Across All NT Regions
            </p>
