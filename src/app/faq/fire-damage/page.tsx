...
export const metadata: Metadata = {
  title: 'fire damage FAQ | Common Questions Answered | Expert Guide',
  description: 'Everything you need to know about fire damage. Expert answers to common questions, tips, and advice.',
};
    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-b from-indigo-900 to-indigo-800 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl font-bold mb-4">Fire damage FAQ</h1>
