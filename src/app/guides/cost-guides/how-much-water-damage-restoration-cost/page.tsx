...
export const metadata: Metadata = {
  title: 'Water Damage Restoration Cost Guide Australia 2024 | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "how much does water damage restoration cost in australia". IICRC certified professionals available 24/7 across Australia.',
...
export default function HowMuchWaterDamageRestorationCostPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for how much does water damage restoration cost in australia. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
