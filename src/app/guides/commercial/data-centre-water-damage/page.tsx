...
export const metadata: Metadata = {
  title: 'Data Centre Water Damage Recovery Services | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "data centre water damage recovery". IICRC certified professionals available 24/7 across Australia.',
...
export default function DataCentreWaterDamagePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for data centre water damage recovery. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
