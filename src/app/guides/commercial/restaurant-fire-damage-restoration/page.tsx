...
export const metadata: Metadata = {
  title: 'Restaurant Kitchen Fire Damage Restoration | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "restaurant kitchen fire damage restoration". IICRC certified professionals available 24/7 across Australia.',
...
export default function RestaurantFireDamageRestorationPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for restaurant kitchen fire damage restoration. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
