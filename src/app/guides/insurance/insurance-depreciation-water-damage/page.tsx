...
export const metadata: Metadata = {
  title: 'Understanding Depreciation in Water Damage Claims | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "insurance claim water damage depreciation". IICRC certified professionals available 24/7 across Australia.',
...
export default function InsuranceDepreciationWaterDamagePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for insurance claim water damage depreciation. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
