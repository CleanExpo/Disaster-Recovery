...
export const metadata: Metadata = {
  title: 'Category 3 Water Damage: Insurance Claims Guide | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "category 3 water damage insurance claim". IICRC certified professionals available 24/7 across Australia.',
...
export default function Category3WaterDamageInsurancePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for category 3 water damage insurance claim. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
