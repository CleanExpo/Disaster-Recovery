...
export const metadata: Metadata = {
  title: 'Is Mould Removal Covered by Insurance in Australia? | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "is mould removal covered by insurance in australia". IICRC certified professionals available 24/7 across Australia.',
...
export default function MouldRemovalInsuranceCoveragePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for is mould removal covered by insurance in australia. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
