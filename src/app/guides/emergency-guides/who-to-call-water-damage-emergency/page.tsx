...
export const metadata: Metadata = {
  title: 'Emergency Water Damage: Who to Call First | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "who to call for emergency water damage". IICRC certified professionals available 24/7 across Australia.',
...
export default function WhoToCallWaterDamageEmergencyPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for who to call for emergency water damage. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
