...
export const metadata: Metadata = {
  title: 'Immediate Steps After Flood Damage: Emergency Guide | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "what to do immediately after flood damage". IICRC certified professionals available 24/7 across Australia.',
...
export default function WhatToDoAfterFloodDamagePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for what to do immediately after flood damage. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
