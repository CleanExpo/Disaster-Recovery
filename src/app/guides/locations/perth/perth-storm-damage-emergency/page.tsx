...
export const metadata: Metadata = {
  title: 'Perth Storm Damage Emergency Response | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "perth storm damage emergency response team". IICRC certified professionals available 24/7 across Australia.',
...
export default function PerthStormDamageEmergencyPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for perth storm damage emergency response team. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
