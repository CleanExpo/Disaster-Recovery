...
export const metadata: Metadata = {
  title: 'Canberra Government Building Restoration Services | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "canberra government building restoration". IICRC certified professionals available 24/7 across Australia.',
...
export default function CanberraGovernmentRestorationPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for canberra government building restoration. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
