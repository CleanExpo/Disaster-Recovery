...
export const metadata: Metadata = {
  title: 'Melbourne Apartment Flood Damage Restoration | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "melbourne apartment flood damage restoration". IICRC certified professionals available 24/7 across Australia.',
...
export default function MelbourneApartmentFloodRestorationPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for melbourne apartment flood damage restoration. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
