...
export const metadata: Metadata = {
  title: 'Invoice Shock Epidemic - NSW Fair Trading Warns of Contractor Exploitation | Disaster Recovery Australia',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-800">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="mb-16">
          ...
          <div className="bg-orange-900/20 backdrop-blur-sm border border-orange-400/30 rounded-lg p-8">
            <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-900/50 to-green-900/50 backdrop-blur-sm border border-blue-400/30 rounded-lg p-8 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/guides/pricing/professional-response-pricing-breakdown" className="bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
                See Transparent Pricing Guide
              </Link>
              <Link href="/guides/insurance/section-54-contractor-rights" className="bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
