...
export const metadata: Metadata = {
  title: 'Emergency Storm Damage Roof Leak Repairs | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "storm damage roof leak emergency repair". IICRC certified professionals available 24/7 across Australia.',
...
export default function StormDamageRoofLeakRepairPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for storm damage roof leak emergency repair. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
