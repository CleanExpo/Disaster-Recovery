...
export const metadata: Metadata = {
  title: 'Best Restoration Companies in Australia: How to Choose | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "which restoration company is best in australia". IICRC certified professionals available 24/7 across Australia.',
...
export default function BestRestorationCompanyAustraliaPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for which restoration company is best in australia. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
