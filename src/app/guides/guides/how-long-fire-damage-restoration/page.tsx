...
export const metadata: Metadata = {
  title: 'Fire Damage Restoration Timeline: What to Expect | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "how long does fire damage restoration take". IICRC certified professionals available 24/7 across Australia.',
...
export default function HowLongFireDamageRestorationPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for how long does fire damage restoration take. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
