...
export const metadata: Metadata = {
  title: 'When to Call Professional Disaster Restoration Services | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "when to call professional disaster restoration". IICRC certified professionals available 24/7 across Australia.',
...
export default function WhenToCallDisasterRestorationPage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for when to call professional disaster restoration. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
