...
export const metadata: Metadata = {
  title: 'Smoke Damage Cleaning After House Fire | Disaster Recovery Australia',
  description: 'Expert answers and solutions for "smoke damage cleaning after house fire". IICRC certified professionals available 24/7 across Australia.',
...
export default function SmokeDamageCleaningGuidePage() {
  const structuredData = {
    ...
    mainEntity: [{
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Professional disaster recovery services for smoke damage cleaning after house fire. Our IICRC certified technicians provide expert solutions with 24/7 emergency response across Australia.',
      },
    }],
  };
