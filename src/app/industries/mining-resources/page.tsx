...
export const metadata: Metadata = {
  title: 'Mining & Resources Disaster Recovery | Specialized Industrial Restoration | Australia',
  description: 'Specialized disaster recovery for mining operations, processing plants, and resource facilities. 24/7 emergency response, insurance approved, minimal downtime guaranteed.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8">
              Specialized disaster recovery for mining operations, processing plants, and resource facilities
            </p>
            ...
            {risks.map((risk, index) => (
              <Card key={index} className="p-6">
                ...
                <p className="text-sm text-gray-600">
                  Specialized response protocols for mining & resources sector
                </p>
              </Card>
            ))}
          </div>
