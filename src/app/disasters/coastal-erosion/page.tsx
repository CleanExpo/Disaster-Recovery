...
export const metadata: Metadata = {
  title: 'Coastal & Storm Surge Damage Services | 24/7 Emergency Response | Disaster Recovery Australia',
  description: 'Specialized coastal property restoration from storm surge, king tides, and erosion damage. Serving All Coastal Areas. 2-4 hours response time.',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-xl mb-8">
              Specialized coastal property restoration from storm surge, king tides, and erosion damage
            </p>
