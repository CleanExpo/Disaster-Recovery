...
const RELATED_PAGES_MAP: Record<CategoryKey, RelatedPage[]> = {
  ...
  'commercial-insurance': [
    ...
    { title: 'For Business Owners', href: '/for-business/business-owners', description: 'Disaster recovery solutions for business owners and commercial operators.' },
    { title: 'For Facilities Managers', href: '/for-business/facilities-managers', description: 'Commercial facilities disaster response and large-scale restoration.' },
  ...
  'commercial': [
    { title: 'For Business Owners', href: '/for-business/business-owners', description: 'Disaster recovery solutions for business owners and operators.' },
    { title: 'For Facilities Managers', href: '/for-business/facilities-managers', description: 'Commercial facilities disaster response and prevention.' },
    { title: 'For Property Managers', href: '/for-business/property-managers', description: 'Property management disaster recovery partnerships.' },
    { title: 'For Strata Managers', href: '/for-business/strata-managers', description: 'Strata and body corporate disaster recovery coordination.' },
