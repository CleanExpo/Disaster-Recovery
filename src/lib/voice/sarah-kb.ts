...
export const SARAH_KB: SarahKnowledgeEntry[] = [
  ...
  },
  {
    ...
    content:
      'Under Australian Privacy Principle 8, callers are informed at the start of every call that the conversation is recorded for quality and compliance purposes and that a brief written transcript may be retained for a limited period. The caller can ask for the call to end at any time. Personal information captured (name, contact details, property postcode, damage description) is used to create the claim and is handled under the Disaster Recovery Privacy Policy published at disasterrecovery.com.au/privacy. Sarah does not recite the full Privacy Policy on the phone — she confirms consent and points the caller to the URL if they want the detail.',
