...
export const metadata: Metadata = generateSEO({
  ...
  description:
    'Verified facts and statistics about Disaster Recovery (NRPG). Platform metrics, Australian disaster data from ABS/BOM/ICA, contractor standards, and service coverage.',
  keywords: [
...
const factsFAQs = [
  ...
  },
  {
    ...
    answer:
      "Contractors bill the client (property owner) directly. This means work begins immediately without waiting for insurer approval. Disaster Recovery provides comprehensive documentation to support the client's insurance reimbursement claim. Payment plans are available through Equipped Commercial Finance.",
  },
];
...
const datasetSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Dataset',
  name: 'Disaster Recovery Platform Facts',
  description:
    'Verified facts and statistics about Disaster Recovery, including platform metrics, contractor standards, and Australian disaster data.',
  url: `${NAP.url}/facts`,
    ...
    <>
      ...
      <AgContentPageTemplate
        hero={{
          ...
          subtitle:
            'Verified data about Disaster Recovery, the Australian disaster landscape, and the restoration industry.',
        }}
        cta={{ text: 'Start a Claim', href: '/claim' }}
        secondaryCta={{ text: 'About Us', href: '/about' }}
        breadcrumbs={[{ label: 'Home', href: '/' }, { label: 'Facts & Statistics' }]}
        stats={[
        ...
        sections={[
          {
            ...
            body: (
              <div className="space-y-4">
                <p>
                  Verified metrics about the Disaster Recovery platform, current as of February
                  2026.
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  {[
                    {
                      fact: 'Platform type',
                      value: 'National claims distribution network',
                      source: 'NRPG',
                    },
                    {
                      fact: 'Operating entity',
                      value: 'National Restoration Professionals Group Pty Ltd',
                      source: 'ABR',
                    },
                    ...
                    {
                      fact: 'Geographic coverage',
                      value: 'All 8 Australian states and territories',
                      source: 'NRPG',
                    },
                    {
                      fact: 'Platform availability',
                      value: '24 hours, 7 days, 365 days per year',
                      source: 'NRPG',
                    },
                    {
                      fact: 'Contractor certification',
                      value: '100% IICRC certified',
                      source: 'NRPG',
                    },
                    { fact: 'Minimum public liability', value: '$20,000,000 AUD', source: 'NRPG' },
                    { fact: 'Minimum service fee', value: '$2,200 AUD', source: 'NRPG' },
                    {
                      fact: 'Target emergency response',
                      value: '60 minutes (metropolitan areas)',
                      source: 'NRPG',
                    },
                    {
                      fact: 'Service categories',
                      value:
                    ...
                    {
                      fact: 'Payment plans',
                      value: 'Available via Equipped Commercial Finance',
                      source: 'NRPG',
                    },
          ...
          },
          {
            ...
            body: (
              <div className="space-y-4">
                <p>
                  Key statistics about natural disasters and property damage in Australia, sourced
                  from the Bureau of Meteorology (BOM), Insurance Council of Australia (ICA), and
                  Australian Bureau of Statistics (ABS).
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  {[
                    {
                      stat: 'ICA catastrophe events (2022)',
                      value: '8 declared events',
                      source: 'ICA',
                    },
                    {
                      stat: 'Total insured losses (2022)',
                      value: '$7.4 billion AUD',
                      source: 'ICA',
                    },
                    {
                      stat: 'Flood-affected properties (Feb 2022)',
                      value: '60,000+ homes across NSW and QLD',
                      source: 'BOM / SES',
                    },
                    {
                      stat: 'Annual severe weather events',
                      value: '100+ (storms, cyclones, floods, bushfires)',
                      source: 'BOM',
                    },
                    {
                      stat: 'Black Summer bushfire losses (2019-20)',
                      value: '$2.32 billion insured losses',
                      source: 'ICA',
                    },
                    {
                      stat: 'Water damage claims',
                      value: 'Most common property insurance claim in Australia',
                      source: 'ICA',
                    },
                    {
                      stat: 'Australian residential properties',
                      value: '10.8 million (2021 Census)',
                      source: 'ABS',
                    },
                    {
                      stat: 'Properties in high-risk flood zones',
                      value: '1 in 10 Australian properties',
                      source: 'Climate Council',
                    },
                    {
                      stat: 'Average water damage claim value',
                      value: '$5,000–$50,000+ depending on severity',
                      source: 'ICA',
                    },
                    {
                      stat: 'Cyclone-exposed population',
                      value: '1.1 million Australians in cyclone-prone areas',
                      source: 'BOM',
                    },
          ...
          },
          {
            ...
            body: (
              <div className="space-y-4">
                <p>
                  The restoration industry in Australia is governed by international and national
                  standards. All Disaster Recovery network contractors must comply with the
                  following:
                </p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                  {[
                    ...
                    {
                      cert: 'AS/NZS 4360',
                      fullName: 'Risk Management Standard',
                      scope:
                    ...
                    {
                      cert: 'WorkSafe',
                      fullName: 'Workplace Health & Safety',
                      scope:
                    ...
                    },
                    {
                      ...
                      scope: 'International standard for consistent quality management processes.',
                      href: '/certifications/iso-certified',
                    },
                    {
                      cert: 'Asbestos Licence',
                      fullName: 'Asbestos Handling & Removal',
                      scope:
                    ...
                    {
                      cert: 'HAZMAT',
                      fullName: 'Hazardous Materials Handling',
                      scope:
        ...
        relatedPages={[
          {
            ...
            href: '/about',
            description:
              'Learn about Disaster Recovery and our national claims distribution platform.',
          },
          {
            title: 'Our Certifications',
            href: '/certifications',
            description:
              'View the professional certifications required for all contractors in our network.',
          },
          {
            title: 'How It Works',
            href: '/how-it-works',
            description: 'Step-by-step guide to using our platform for disaster recovery claims.',
          },
          {
            title: 'Start a Claim',
            href: '/claim',
            description: 'Submit your damage claim online for immediate contractor matching.',
          },
        ]}
      />
    </>
