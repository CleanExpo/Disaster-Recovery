...
const PRIORITY_MAP: Record<string, number> = {
  ...
  '/guides/locations/gold-coast/gold-coast-alfred-recovery': 0.95,
  '/guides/locations/brisbane/brisbane-alfred-recovery': 0.95,
  '/guides/locations/sunshine-coast/sunshine-coast-alfred-recovery': 0.9,
  '/guides/locations/northern-nsw/northern-nsw-alfred-recovery': 0.9,
  '/guides/locations/ipswich/ipswich-floods-2026': 0.95,
  '/guides/locations/bundaberg/bundaberg-floods-2026': 0.95,
  '/guides/locations/gladstone/gladstone-floods-2026': 0.9,
  '/guides/locations/rockhampton/rockhampton-floods-2026': 0.9,
...
const FREQUENCY_MAP: Record<string, MetadataRoute.Sitemap[0]['changeFrequency']> = {
  ...
  '/guides/locations/gold-coast/gold-coast-alfred-recovery': 'daily',
  '/guides/locations/brisbane/brisbane-alfred-recovery': 'daily',
  '/guides/locations/sunshine-coast/sunshine-coast-alfred-recovery': 'daily',
  '/guides/locations/northern-nsw/northern-nsw-alfred-recovery': 'daily',
  '/guides/locations/ipswich/ipswich-floods-2026': 'daily',
  '/guides/locations/bundaberg/bundaberg-floods-2026': 'daily',
  '/guides/locations/gladstone/gladstone-floods-2026': 'daily',
  '/guides/locations/rockhampton/rockhampton-floods-2026': 'daily',
