        ...
        <div className="r6-container">
          <div className="r6-nav-container">
            ...
            <ul className="r6-nav-menu">
              <li>
                <a href="#services" className="r6-nav-link">
                  Services
                </a>
              </li>
              <li>
                <a href="#about" className="r6-nav-link">
                  About
                </a>
              </li>
              <li>
                <a href="#process" className="r6-nav-link">
                  Process
                </a>
              </li>
              <li>
                <a href="#contact" className="r6-nav-link">
                  Contact
                </a>
              </li>
            </ul>
            <div className="r6-flex r6-gap-3">
              <button className="r6-btn r6-btn-ghost r6-btn-sm">Partner Portal</button>
          ...
          <div className="r6-hero-content">
            <div className="r6-stagger">
              <div className="r6-mb-4">
                <span className="r6-text-primary r6-font-semibold">
              ...
              <p className="r6-hero-subtitle r6-mb-6 text-balance">
                Professional restoration services for water damage, fire damage, and mould
                remediation. IICRC certified technicians available 24/7 across Queensland.
              </p>
              <div className="r6-flex r6-gap-3">
                ...
                <button className="r6-btn r6-btn-secondary r6-btn-lg">Free Assessment</button>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="r6-grid r6-grid-cols-1 r6-grid-cols-2-tablet r6-grid-cols-4-desktop">
            {services.map((service, index) => (
              ...
              >
                <div className="r6-mb-4">
                  <div
                    className={`r6-inline-block r6-p-3 ${service.colour === 'primary' ? 'r6-bg-primary' : 'r6-bg-dark'}`}
                    style={{
                      borderRadius: 'var(--r6-radius-xl)',
                    }}
                  >
        ...
        <div className="r6-container">
          <div className="r6-text-center">
            ...
            <div className="r6-flex r6-justify-center r6-gap-3">
              ...
              <button
                className="r6-btn r6-btn-secondary r6-btn-lg"
                style={{
      ...
      <section id="process" className="r6-section">
        <div className="r6-container">
          <div className="r6-text-center r6-mb-6">
            ...
            <p className="r6-text-gray r6-text-lg">Systematic approach to complete restoration</p>
          </div>
        ...
        <div className="r6-container">
          <div className="r6-text-center">
            <p className="r6-text-light" style={{ opacity: 0.8 }}>
              © 2025 Disaster Recovery. All rights reserved.
            </p>
