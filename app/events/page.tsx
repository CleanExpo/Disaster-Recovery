...
const events = [
  ...
  },
  {
    ...
    title: 'TC Maila FNQ — Recovery Active',
    type: 'Cyclone',
    phase: 'Recovery Active',
    state: 'QLD',
    lgas: 'Cairns, Port Douglas, Innisfail, Cassowary Coast',
    description: 'TC Maila made landfall on the FNQ coast 11–12 April 2026. Post-clearance recovery response active. Lodge your TC Maila claim 24/7.',
    badgeColour: 'bg-green-600',
  },
  {
    slug: 'cyclone-maila-queensland-2026',
    title: 'TC Maila — QLD Recovery',
    type: 'Cyclone',
    phase: 'Recovery Active',
    state: 'QLD',
    lgas: 'Far North Queensland',
    description: 'TC Maila made landfall on the FNQ coast on 11–12 April 2026. IICRC-certified contractors responding post-clearance across Cairns, Port Douglas, Innisfail, and the Cassowary Coast.',
    badgeColour: 'bg-green-600',
  },
  {
