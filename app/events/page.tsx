...
const events = [
  ...
  },
  {
    ...
    title: 'TC Maila FNQ — Category 4',
    type: 'Cyclone',
    phase: 'Pre-Landfall',
    state: 'QLD',
    lgas: 'Cairns, Townsville, Cape York',
    description: 'Tropical Cyclone Maila (Category 4, 165 km/h) — IICRC-certified contractors on standby in Cairns, Townsville, and Cape York. Landfall forecast 11–12 April 2026.',
