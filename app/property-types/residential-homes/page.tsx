...
export const metadata: Metadata = {
  ...
  description: 'Complete disaster recovery for houses, townhouses, and residential properties. IICRC-certified contractors, 24/7 emergency response, full claims documentation.',
