      ...
      case 'services':
        return (
          <div className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-2xl font-bold text-white">Browse Services</h3>
                <p className="text-gray-400 mt-1">Professional restoration and construction services</p>
              </div>
  ...
  return (
    <div className="min-h-screen bg-gray-900">
        ...
        <div className="w-full px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-bold text-white">Restoration Marketplace</h1>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                <Avatar className="h-8 w-8">
                  ...
                  <AvatarFallback className="bg-[#00BFA6] text-white text-sm">
                    {user.name?.charAt(0) || user.email.charAt(0).toUpperCase()}
                  </AvatarFallback>
                </Avatar>
                <div className="hidden sm:block">
                  <p className="text-sm font-semibold text-white">{user.name || 'Client'}</p>
                </div>
              </div>
      ...
      <div className="flex h-screen">
        {/* Fixed Sidebar */}
        <div className={`fixed top-16 left-0 z-40 w-64 h-[calc(100vh-4rem)] bg-gray-800 shadow-xl border-r border-gray-700 transform transition-all duration-300 ease-in-out lg:translate-x-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
          <nav className="h-full flex flex-col">
            ...
            <div className="lg:hidden p-4 border-b border-gray-700">
              <Button
                variant="ghost"
                size="sm"
                className="w-full justify-center hover:bg-gray-700 transition-colors text-gray-300 hover:text-white"
            ...
            <div className="space-y-2 flex-1 p-4">
              ...
              <Button
                ...
                onClick={() => setActiveTab('services')}
              >
                <Search className={`h-5 w-5 mr-3 transition-colors duration-200 ${activeTab === 'services' ? 'text-white' : 'text-gray-500'}`} />
                <span className="font-medium transition-colors duration-200">Browse Services</span>
              </Button>
              ...
              >
                <Plus className={`h-5 w-5 mr-3 transition-colors duration-200 ${activeTab === 'requests' ? 'text-white' : 'text-gray-500'}`} />
                <span className="font-medium transition-colors duration-200">My Requests</span>
                {serviceRequests.length > 0 && (
              ...
              >
                <Users className={`h-5 w-5 mr-3 transition-colors duration-200 ${activeTab === 'contractors' ? 'text-white' : 'text-gray-500'}`} />
                <span className="font-medium transition-colors duration-200">Contractors</span>
              </Button>
