...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://disasterrecovery.com.au/guides/compliance/accc-claims-intake-audit',
  },
};
    ...
    <>
      ...
      <AgGuidePageTemplate
        ...
        sections={[
              ...
              <>
                ...
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem' }}>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Hidden fee disclosure:</strong> A service is advertised at one price but
                    additional charges appear only at the final stage of an online form — after the
                    consumer has invested time and personal information.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                  ...
                  <li style={{ marginBottom: '0.5rem' }}>
                    ...
                    sharing authorisations arrive pre-ticked, so the consumer shares data they did
                    not affirmatively choose to share.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Confirmshaming:</strong> The &ldquo;decline&rdquo; option on a prompt is
                    phrased to make the consumer feel foolish or reckless for declining — for
                    example, &ldquo;No thanks, I don&apos;t want help protecting my family.&rdquo;
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                  ...
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Bait-and-switch pricing:</strong> The service described during the
                    intake process differs materially from what is ultimately delivered — a
                    different contractor, scope, or price to the one discussed at sign-up.
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
            ...
            body: (
              <>
                <p>
                  ...
                  and compliance priorities. For 2026–27, the ACCC has identified two areas directly
                  relevant to insurance and claims platforms:
                </p>
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem' }}>
                  <li style={{ marginBottom: '0.5rem' }}>
                    ...
                    during periods of vulnerability — including financial stress, health events, and
                    natural disasters. Claim intake platforms that use urgency, hidden fees, or
                    manipulative consent flows during or after a disaster event fall squarely within
                    this priority.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Subscription traps and forced continuity:</strong> Any platform that
                    enrolls consumers in recurring charges or ongoing service agreements through a
                    claims or emergency intake process — without clear, upfront disclosure — is a
                    current ACCC enforcement target.
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  The ACCC&apos;s enforcement posture reflects a broader regulatory shift: conduct
                  that might previously have been treated as a civil dispute between a business and
                  a consumer is increasingly attracting ACCC investigation and, where appropriate,
                  court proceedings with civil penalty exposure.
                </p>
                <p style={{ marginTop: '1rem' }}>
              ...
              <>
                ...
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem' }}>
                  <li style={{ marginBottom: '0.75rem' }}>
                    ...
                    consumer has entered all their personal, insurance, and property information and
                    is presented with a final submission page. Under ACL s29, the full price must be
                    disclosed at the earliest reasonable opportunity.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    <strong>2. False urgency in disaster contexts:</strong> Countdown timers,
                    &ldquo;act now before your claim window closes&rdquo; banners, or &ldquo;only 3
                    contractors available in your area&rdquo; claims on emergency intake forms
                    create artificial pressure. Disaster-affected consumers are already under acute
                    time pressure from real constraints (drying windows, insurer reporting
                    obligations) — manufacturing additional urgency exploits that pressure.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                  ...
                  <li style={{ marginBottom: '0.75rem' }}>
                    ...
                    management&rdquo; or &ldquo;advocate&rdquo; service signed up through a disaster
                    intake form may include an ongoing fee tied to the claim settlement amount or a
                    recurring monthly subscription. If this commitment is buried in extended terms
                    rather than prominently disclosed in the intake flow, the ACCC treats this as an
                    unfair practice under the ACL.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    ...
                    will result in a higher insurance payout, faster claim settlement, or a specific
                    outcome are making representations about the future. Under ACL s4,
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  The Australian Consumer Law (ACL), which operates as Schedule 2 to the Competition
                  and Consumer Act 2010, provides two key protections against dark patterns and
                  misleading conduct in claims and services platforms.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  <strong>Section 18 — Misleading or Deceptive Conduct:</strong> Section 18
                  prohibits any person engaging in trade or commerce from engaging in conduct that
                  is misleading or deceptive, or likely to mislead or deceive. This is a broad
                  prohibition: it covers not only false statements but also conduct that creates a
                  false impression — including user interface design that leads a consumer to
                  believe they are agreeing to one thing when they are agreeing to another. Section
                  18 does not require proof of intent; if the overall impression created by a
                  platform is misleading, the conduct contravenes the ACL.
                </p>
                <p style={{ marginTop: '1rem' }}>
                ...
                <p style={{ marginTop: '1rem' }}>
                  Contraventions of s29 carry civil penalties for corporations. If you believe a
                  platform has breached s18 or s29 in connection with your claim, you can report the
                  conduct to the ACCC at accc.gov.au and seek to recover loss through the courts or
                  via AFCA if the conduct is connected to an insurance product.
                </p>
              </>
            ),
          },
            ...
            body: (
              <>
                <p>
                  ...
                  the ACL that would prohibit &ldquo;unfair trading practices&rdquo; as a standalone
                  category, separate from the existing misleading or deceptive conduct framework.
                </p>
                <p style={{ marginTop: '1rem' }}>
                ...
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem' }}>
                  ...
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Asymmetric exit conditions:</strong> Designing a service so that sign-up
                    is quick and easy but cancellation or withdrawal is disproportionately difficult
                    would be captured as an unfair practice under the proposed framework.
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  ...
                  likely direction of the reforms, given the ACCC&apos;s stated intent to use the
                  new provisions actively once enacted.
                </p>
              </>
            ),
          },
          {
            ...
            body: (
              <>
                <p>
                  The Disaster Recovery platform connects homeowners directly with certified
                  contractors from the National Restoration Professionals Group (NRPG) network. The
                  following practices reflect our approach to the consumer protections described in
                  this guide.
                </p>
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem' }}>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Transparent pricing from step one:</strong> The platform fee and the
                    amount held for your contractor are disclosed on the claim form before you enter
                    any personal or insurance details. There are no fees that appear only at the
                    final submission step.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>No pre-ticked checkboxes:</strong> Every authorisation on the claim form
                    — property access, insurance liaison, work commencement, marketing
                    communications, and privacy consent — begins unchecked. You make an affirmative
                    choice for each one.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Clear platform role disclosure:</strong> The form explicitly states that
                    Disaster Recovery is a contractor-matching platform, not the party performing
                    the work or controlling the claim outcome. This is disclosed on entry, on the
                    authorisations step, and on the submission confirmation.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>APP 5 collection notice:</strong> The privacy collection notice on the
                    form complies with Australian Privacy Principle 5, identifying who collects your
                    information, why, who it is disclosed to, and how to access or correct it. The
                    notice is available in multiple languages.
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>No manufactured urgency:</strong> The claim form contains no countdown
                    timers, scarcity claims, or pressure language beyond accurate descriptions of
                    the service timeline (contractor contact as soon as a certified contractor is
                    confirmed for your area during business hours).
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>No claims outcome representations:</strong> NRPG does not represent that
                    using our platform will result in a higher insurance payout, faster claim
                    settlement, or any particular outcome from your insurer. The outcome of your
                    insurance claim is between you and your insurer.
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  ...
                  or lodge a complaint with the Office of the Australian Information Commissioner
                  (OAIC) at oaic.gov.au.
                </p>
              </>
            ),
        ...
        faqs={[
          {
            question:
              'Can I report a dark pattern used by an insurance or claims platform to the ACCC?',
            answer:
          ...
          {
            question: 'What is the difference between a dark pattern and normal sales persuasion?',
            answer:
              'Australian consumer law does not prohibit persuasion — it prohibits misleading or deceptive conduct and (where proposed legislation passes) unfair trading practices. A company can lawfully highlight the benefits of its service, promote urgency where that urgency is genuine, and design interfaces that draw attention to particular options. What it cannot do is create a false impression, use interface design to trick consumers into choices they would not otherwise make, or exploit the vulnerability of consumers under stress. The test under ACL s18 is whether the overall conduct is misleading or likely to mislead — not whether any individual element is technically true.',
          },
          {
