...
export const metadata: Metadata = {
  title:
    'ANSI/IICRC S500 Water Damage Restoration — What Certified Contractors Do | Disaster Recovery',
  description:
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'ANSI/IICRC S500:2025 is the current Standard for Professional Water Damage Restoration, published by the IICRC. It is the professional benchmark certification standard for water damage restoration contractors in Australia. For the full standard, visit iicrc.org.',
      },
    },
    {
      '@type': 'Question',
        ...
        sections={[
          {
            ...
            body: (
              <>
                <p>
                  Water damage restoration in Australia is performed to{' '}
                  <strong>ANSI/IICRC S500:2025</strong> — the current edition of the Standard for
                  Professional Water Damage Restoration, published by the Institute of Inspection,
                  Cleaning and Restoration Certification (IICRC). This is the professional benchmark
                  referenced by insurers, loss adjusters, and the Australian Financial Complaints
                  Authority (AFCA) when assessing whether restoration work was completed
                  appropriately.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  All contractors in the NRPG network hold current IICRC Water Damage Restoration
                  Technician (WRT) certification. For the full ANSI/IICRC S500:2025 standard, visit{' '}
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Water damage creates hidden moisture in wall cavities, subfloor spaces,
                  insulation, and building materials that are not visible to the eye. Inadequate
                  drying — or drying that stops too soon — leaves residual moisture that causes
                  secondary damage: mould growth, structural timber deterioration, and persistent
                  musty odour, often appearing weeks after the initial incident.
                </p>
                <p style={{ marginTop: '1rem' }}>
                ...
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    Assess the source and extent of water intrusion using moisture meters and
                    thermal imaging
                  </li>
                  <li>
                    Determine whether water contamination requires additional decontamination steps
                    beyond drying
                  </li>
                  <li>
                    Calculate and place drying equipment based on the affected area and material
                    types
                  </li>
                  <li>
                ...
                <p style={{ marginTop: '1rem' }}>
                  A general builder or cleaner does not have this specialist drying expertise.
                  Equipment placed without moisture assessment can dry surfaces while leaving
                  structural materials wet — with secondary mould damage appearing later.
                </p>
              </>
            ),
          },
          {
            ...
            body: (
              <>
                <p>
                  An ANSI/IICRC S500:2025-certified job produces documentation that supports your
                  insurance claim. If a contractor cannot provide these records, the job may not
                  have been performed to standard:
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    <strong>Pre-drying moisture readings</strong> — Baseline measurements of all
                    affected materials before drying begins. Required to demonstrate the starting
                    condition and track progress.
                  </li>
                  <li>
                    <strong>Written scope of works</strong> — All affected areas and materials, the
                    equipment applied, and the drying method used for each material type.
                  </li>
                  <li>
                    <strong>Daily moisture monitoring records</strong> — Readings taken each day
                    showing drying progress toward the structural materials&apos; target moisture
                    content.
                  </li>
                  <li>
                    <strong>Final drying documentation</strong> — Confirmation that all affected
                    materials have reached drying goals. This is the close-out document your insurer
                    requires.
                  </li>
                  <li>
                ...
                <p style={{ marginTop: '1rem' }}>
                  This documentation is what AFCA references when a policyholder disputes whether
                  drying was completed. If your insurer&apos;s contractor did not provide moisture
                  readings or daily drying records, the job documentation is incomplete.
                </p>
              </>
            ),
          },
            ...
            body: (
              <>
                <p>
                  ...
                  right conditions. Properties that were flooded in Queensland and NSW 2025–2026 ICA
                  Significant Events are at ongoing risk of secondary mould damage where structural
                  drying was not completed to standard.
                </p>
                <p style={{ marginTop: '1rem' }}>
                ...
                <p style={{ marginTop: '1rem' }}>
                  ...
                  ANSI/IICRC S500:2025 assessment documents whether original drying was completed to
                  standard and what secondary damage has resulted.
                </p>
              </>
            ),
          },
            ...
            body: (
              <>
                <p>
                  ...
                  storm surge, cyclone flooding, and rainfall-driven inundation. This is relevant to
                  Australian policyholders because the category of water determines the scope of
                  remediation required.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  The Consensus Body position clarifies how weather-sourced water — including
                  floodwater, storm surge, and cyclone-driven inundation — is classified under the
                  S500 framework. Contractors not working to the 2025 edition may be applying
                  outdated categorisation that does not reflect the current standard position, which
                  can affect the scope of works and the appropriateness of any restoration approach.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  For Australian homeowners affected by cyclone or flood events — including Ex-TC
                  Alfred, TC Maila, and the 2026 Queensland and NSW flood events — this matters
                  because insurer-appointed contractors may be categorising the water source
                  differently to what the current S500 Consensus Body position requires. An
                  independent ANSI/IICRC S500:2025 assessment applies the current standard and
                  documents the water category as the basis for the restoration scope.
                </p>
                <p style={{ marginTop: '1rem' }}>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Water damage restoration disputes most commonly arise from incomplete drying —
                  where surface materials appear dry but structural components remain wet. If you
                  have concerns about the drying work performed by your insurer&apos;s contractor:
                </p>
                <ol style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2.2 }}>
                  <li>
                    <strong>Request all moisture reading records and the drying report</strong> from
                    the original contractor before accepting the claim closure.
                  </li>
                  <li>
                    <strong>Get an independent ANSI/IICRC S500:2025 assessment</strong> that
                    documents current moisture levels and any secondary damage.
                  </li>
                  <li>
                    <strong>Lodge an internal dispute with your insurer</strong> if you believe
                    drying was incomplete. Attach the independent assessment.
                  </li>
                  <li>
