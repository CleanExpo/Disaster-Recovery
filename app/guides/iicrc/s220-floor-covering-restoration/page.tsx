...
const faqSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: "Yes. You can request an independent assessment through Disaster Recovery even if your insurer has already appointed a repairer. An independent scope of works gives you an objective basis for reviewing whether the insurer-appointed contractor's scope captures the full extent of damage — particularly subfloor items that are commonly missed. If you believe the scope is incomplete, documentation from an independent certified restorer provides the evidence base for a dispute through AFCA.",
      },
    },
  ],
};
        ...
        sections={[
            ...
            body: (
              <>
                <p>
                  ...
                  floor covering restoration. Certification confirms that a contractor has the
                  professional knowledge to assess, scope, and restore floor coverings — including
                  carpet, hardwood and engineered timber, vinyl and luxury vinyl tile (LVT), ceramic
                  and porcelain tile, and natural stone — following water, mould, fire, and smoke
                  damage events.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  Floor covering restoration is a specialist discipline. In most damage scenarios,
                  floors are affected alongside structural drying (S500) and mould remediation
                  (S520) requirements. A contractor certified across all three areas treats the
                  floor coverings and the building structure as one integrated scope — not separate
                  jobs.
                </p>
              </>
            ),
              ...
              <>
                ...
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                  <li style={{ marginBottom: '0.5rem' }}>
                    ...
                    affected floor surfaces and subfloors using calibrated meters before any work
                    begins; this establishes the full extent of damage and documents it for the
                    insurance claim
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Subfloor assessment</strong> — assessing the substrate separately from
                    the surface floor covering; wet subfloors beneath visually intact LVT or tile
                    are frequently missed when non-specialist contractors handle floor damage
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Restoration-versus-replacement scoping</strong> — determining what can
                    be restored and what requires replacement based on material condition,
                    contamination type, and manufacturer requirements; each decision is documented
                    with supporting evidence
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Drying system selection and monitoring</strong> — selecting equipment
                    and conditions appropriate to the floor covering type (timber requires slow,
                    controlled drying; carpet tolerates more aggressive airflow) and monitoring
                    daily
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Antimicrobial treatment</strong> — applying treatment where water damage
                    creates conditions for mould growth, particularly in carpet underlay, timber
                    joints, and grout
                  </li>
                  <li>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Not all floor coverings respond to water, mould, or fire damage in the same way.
                  The following is general guidance only; every job requires direct assessment by a
                ...
                <ul style={{ marginTop: '1rem', paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                  <li style={{ marginBottom: '0.75rem' }}>
                    ...
                    underlay. Restoration is possible when the water source is clean and the carpet
                    is treated quickly. Contaminated water or extended exposure typically requires
                    replacement. Underlay almost always requires replacement regardless of carpet
                    condition.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    <strong>Hardwood and engineered timber</strong> — absorbs moisture and expands,
                    leading to cupping, swelling at joints, and finish failure. Cupping is
                    frequently reversible with controlled drying, but the timeline can extend weeks
                    or months. Hardwood damage is commonly under-scoped in initial assessments
                    because manifestation is delayed.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    <strong>Vinyl and LVT</strong> — can appear unaffected while moisture migrates
                    through adhesive to the subfloor beneath. Adhesive failure, bubbling, and
                    lifting at seams are common secondary outcomes. The subfloor beneath vinyl
                    frequently requires treatment even when the vinyl surface looks intact.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    <strong>Ceramic and porcelain tile</strong> — the tile itself is generally
                    unaffected by water, but grout lines are permeable and the substrate can become
                    fully saturated. Once saturated, tiles can lift, crack, or debond. Assessment
                    must include moisture content of the substrate, not just surface inspection.
                  </li>
                  <li style={{ marginBottom: '0.75rem' }}>
                    <strong>Natural stone</strong> — porous and susceptible to staining and mineral
                    deposits when exposed to contaminated water. Restoration requires specialist
                    cleaning techniques; standard products used on other floor types can permanently
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Floor covering damage is one of the most commonly under-scoped elements of a water
                  or fire damage claim.
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Subfloor damage is not visible without moisture testing</strong> — an
                    assessor relying on visual inspection alone cannot determine whether the
                    subfloor beneath LVT or tile is saturated
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Hardwood cupping takes time to manifest</strong> — a timber floor that
                    appears flat days after a water event can develop cupping over subsequent weeks;
                    initial assessments carried out too early may miss this
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    <strong>Partial replacement may not be appropriate</strong> — when matching
                    boards are no longer available, or moisture has spread beyond the visible damage
                    zone, partial replacement results in a permanently mismatched floor or recurring
                    problems
                  </li>
                </ul>
                <p style={{ marginTop: '0.75rem' }}>
                  When a certified contractor documents moisture readings, subfloor assessments, and
                  the basis for restoration-versus-replacement decisions, the claim scope is
            ...
            body: (
              <>
                ...
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', listStyleType: 'disc' }}>
                  ...
                  <li style={{ marginBottom: '0.5rem' }}>
                    Will you assess and moisture-map the subfloor separately from the surface
                    covering?
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    What is your basis for recommending restoration versus replacement for this
                    floor type?
                  </li>
                  <li style={{ marginBottom: '0.5rem' }}>
                    How frequently will you monitor drying progress and record readings?
                  </li>
