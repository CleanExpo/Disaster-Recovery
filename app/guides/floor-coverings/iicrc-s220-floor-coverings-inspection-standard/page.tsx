...
export const metadata: Metadata = {
  title: 'Floor Covering Inspection After Water or Flood Damage | Disaster Recovery',
  description:
    ...
    <>
      ...
      <AgGuidePageTemplate
        ...
        sections={[
          {
            ...
            body: (
              <>
                <p>
                  Professional floor covering inspection in Australia is performed to{' '}
                  <strong>ANSI/IICRC S220</strong> — the Standard for the Inspection of Flooring
                  Systems, published by the Institute of Inspection, Cleaning and Restoration
                  Certification (IICRC). This is the professional benchmark for assessing installed
                  flooring systems after water damage, flooding, or other loss events — and is the
                  standard referenced by insurers and AFCA when evaluating whether a flooring
                  assessment was conducted appropriately.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  The ANSI/IICRC S220 standard is currently under revision with public review
                  closing 19 April 2026. Contractors in the NRPG network hold current IICRC Floor
                  Care Technician (FCT) certification. For information on the ANSI/IICRC S220
                  standard, visit{' '}
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Flooring is the most visible component of water or flood damage — but surface
                  appearance alone does not determine whether flooring can be restored or must be
                  replaced. Water migrates beneath flooring materials, into the subfloor and
                  structural elements below, where moisture is invisible without specialist
                  equipment.
                </p>
                <p style={{ marginTop: '1rem' }}>
                ...
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    Measure moisture content within the flooring material and the subfloor beneath
                    it — not just surface moisture
                  </li>
                  <li>
                    Assess the type of water source (clean, grey, or contaminated) and whether the
                    flooring material can be safely retained after exposure
                  </li>
                  <li>
                    Determine whether individual floor types — hardwood, engineered timber,
                    laminate, vinyl, carpet, or tile — are restorable or require replacement based
                    on the extent and duration of exposure
                  </li>
                  <li>
                    Identify subfloor damage, mould onset, or structural issues that would prevent
                    retained flooring from performing correctly
                  </li>
                  <li>
                    Document all findings with moisture readings and photographs to support the
                    insurance claim and justify the restoration or replacement recommendation
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  A general builder or cleaner does not have this specialist flooring assessment
                  training. Retained flooring that was not properly assessed may cup, buckle,
                  delaminate, or develop mould beneath the surface — causing secondary damage and a
                  second insurance dispute months after the original claim was closed.
                </p>
              </>
            ),
          },
          {
            ...
            body: (
              <>
                <p>
                  A professional floor covering assessment produces documentation your insurance
                  claim requires. If the contractor cannot provide these records, the assessment may
                  not have been conducted to the standard required:
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    <strong>Moisture reading records</strong> — Baseline moisture measurements taken
                    in the flooring material, the subfloor, and adjacent structural elements before
                    any decision on restoration or replacement is made.
                  </li>
                  <li>
                    <strong>Water source classification</strong> — Documentation of the water source
                    type, as this directly affects whether porous materials such as carpet and
                    timber can be safely retained.
                  </li>
                  <li>
                    <strong>Scope of works — floor-by-floor</strong> — Each affected area documented
                    separately: floor type, extent of damage, moisture readings, and the recommended
                    course of action (dry in place, lift and dry, or replace).
                  </li>
                  <li>
                    <strong>Photographic evidence</strong> — Before and after photographs showing
                    condition at time of assessment, during drying, and upon completion.
                  </li>
                  <li>
                    <strong>Matching assessment</strong> — Where partial replacement is required,
                    documentation of whether matching replacement product is available — relevant to
                    insurance matching rights claims.
                  </li>
                  <li>
                    <strong>Completion readings</strong> — Final moisture readings confirming
                    retained flooring has reached acceptable moisture content before the job is
                    closed.
                  </li>
                </ul>
              </>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  One of the most common flooring insurance disputes arises when an insurer&apos;s
                  contractor recommends drying retained flooring that should be replaced — or
                  conversely, replaces flooring that could have been restored. Both errors have
                  financial consequences for the policyholder. An ANSI/IICRC S220-certified
                  assessment bases this decision on objective criteria, not cost minimisation:
                </p>
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  {[
                    ...
                    >
                      <div style={{ fontWeight: 700, color: item.color, marginBottom: '0.5rem' }}>
                        {item.type}
                      </div>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  A frequently disputed insurance issue after floor damage is the insurer&apos;s
                  obligation when only part of a floor run is damaged. If the damaged section cannot
                  be matched — because the product is discontinued, the colour has faded, or the
                  exact product is no longer available — replacing only the damaged section leaves a
                  visible mismatch.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  AFCA has ruled on flooring matching disputes in policyholders&apos; favour in
                  cases where:
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    The replacement product could not be matched to the undamaged portion within the
                    same room or open-plan space
                  </li>
                  <li>
                    The insurer&apos;s scope only covered the damaged section, leaving a visually
                    mismatched floor
                  </li>
                  <li>
                    The policyholder provided independent documentation that a match was not
                    available
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  An independent ANSI/IICRC S220 assessment documents whether matching replacement
                  product is available, and what the reasonable scope of replacement is — including
                  adjoining areas where a visible mismatch would result from partial replacement.
                </p>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Flooring disputes most commonly arise from three scenarios: retained flooring that
                  develops secondary problems after claim closure, partial replacement scopes that
                  produce visible mismatches, and failure to assess subfloor damage beneath retained
                  flooring. If you have concerns:
                </p>
                <ol style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2.2 }}>
                  <li>
                    <strong>Request all assessment documentation</strong> — Moisture readings, scope
                    of works, and the basis for any restoration vs. replacement decision, before
                    accepting claim closure.
                  </li>
                  <li>
                    <strong>Get an independent ANSI/IICRC S220 assessment</strong> — An independent
                    certified contractor documents current flooring condition, moisture levels, and
                    the adequacy of any work already completed.
                  </li>
                  <li>
                    <strong>Lodge an internal dispute with your insurer</strong> — Attach the
                    independent assessment. All Australian insurers must have an internal dispute
                    resolution process.
                  </li>
                  <li>
                    <strong>Escalate to AFCA if unresolved within 30 days</strong> — AFCA accepts
                    flooring and matching disputes at no cost and has a published track record on
                    matching rights cases.
                  </li>
                </ol>
              </>
            ),
        ...
        faqs={[
          ...
          {
            question:
              'Am I entitled to have my entire floor replaced if only part of it was damaged?',
            answer:
