...
export const metadata: Metadata = {
  ...
  description: 'Understand what Australian insurance policies cover for burst pipe water damage, how to document your claim, and how to maximise your settlement. Includes steps for sudden vs gradual leak disputes.',
  keywords: [
  ...
  openGraph: {
    title: 'Burst Pipe Insurance Claim Australia — What Is Covered & What to Do',
    description: 'Step-by-step guide to lodging a burst pipe insurance claim in Australia. What is covered, how to document damage, and how to dispute a denial.',
    type: 'article',
  },
};
  ...
  return (
    <>
      ...
      <AgGuidePageTemplate
        ...
        sections={[
          {
            ...
            body: (
              <div className="space-y-4 text-gray-300">
                ...
                <p>
                  The critical distinction insurers draw is between <strong className="text-white">sudden and accidental</strong> damage versus <strong className="text-white">gradual deterioration</strong>. A pipe that fails without warning is sudden. A pipe that has been slowly seeping behind a wall for months — causing damage that built up gradually — may be denied as gradual damage or poor maintenance.
                </p>
                <div style={{
                  ...
                  <strong className="text-white block mb-2">What burst pipe policies typically cover:</strong>
                  ...
                  <strong className="text-white block mt-3 mb-2">What is typically NOT covered:</strong>
                  <ul className="text-sm space-y-1 list-disc list-inside text-gray-300">
          ...
          },
          {
            ...
            body: (
              <ol className="space-y-3">
                {[
                  { n: '1', title: 'Shut off the main water supply immediately', body: 'Locate the main water shut-off valve (usually in the meter box, under the sink, or near the hot water system) and close it. This stops ongoing water flow and limits the spread of damage.' },
                  { n: '2', title: 'Document all damage before touching anything', body: 'Photograph every affected area — walls, floors, ceilings, contents — before you mop up, move furniture, or begin any cleanup. This photographic record is essential for your insurance claim and cannot be recreated.' },
                  { n: '3', title: 'Lodge an emergency claim with a certified contractor', body: 'Contact an IICRC-certified water damage restoration contractor immediately. Emergency extraction must begin within hours to prevent mould growth. Do not wait for insurance approval.' },
                  { n: '4', title: 'Notify your insurer as soon as practicable', body: 'Call your insurer\'s claims line. Advise that you are commencing emergency make-safe to prevent escalating damage. Provide photographs of the undisturbed damage state.' },
                  { n: '5', title: 'Get the plumber to inspect and document the failure point', body: 'Your licensed plumber\'s written report identifying the cause of the pipe failure (age of pipe, pressure failure, corrosion, physical damage) is valuable evidence if the insurer attempts to classify the damage as gradual.' },
                ].map((step) => (
                  <li
                    key={step.n}
                    style={{
                  ...
                  >
                    ...
                    <div>
                      <strong style={{ color: '#fff', display: 'block', marginBottom: '0.25rem' }}>{step.title}</strong>
          ...
          },
          {
            ...
            body: (
              <div className="space-y-4 text-gray-300">
                ...
                <p>
                  <strong className="text-white">Request the evidence in writing.</strong> Ask for the specific assessor report, photographs, moisture readings, or engineering opinion the insurer relied on to reach the gradual damage conclusion. This is your right under the General Insurance Code of Practice.
                </p>
                <p>
                  Counter-evidence that helps your case:
                </p>
                <ul className="text-sm space-y-2 list-disc list-inside text-gray-400">
                  <li>Licensed plumber&apos;s report identifying a specific failure point (e.g., failed O-ring, corrosion fracture, joint failure).</li>
                  <li>IICRC restoration contractor&apos;s assessment showing acute moisture patterns consistent with a sudden event rather than slow saturation.</li>
                  <li>Property inspection records, recent renovation photographs, or maintenance records showing no prior evidence of a leak.</li>
                  <li>Water bill records — a gradual leak significant enough to cause building damage would typically show elevated water consumption over time.</li>
                </ul>
                <p>
            ...
            body: (
              <div className="space-y-3 text-gray-300">
                ...
                <ul className="space-y-2 text-sm list-disc list-inside text-gray-400">
                  <li>Do not accept a cash settlement before the full scope of structural damage is confirmed. Hidden moisture inside walls, under flooring, and in insulation often becomes visible only after drying is complete.</li>
                  <li>Obtain IICRC-certified drying logs and moisture readings as the basis for your scope of works. Insurers take these seriously.</li>
                  <li>Document all contents losses with photographs, purchase receipts, serial numbers, and replacement cost quotes — not just the original purchase price.</li>
                  <li>Understand depreciation — policies may apply depreciation to older contents. Ask whether your policy covers replacement cost or indemnity (depreciated) value.</li>
                  <li>You have the right to seek a second opinion on the scope of damage if you disagree with the insurer&apos;s assessor.</li>
                </ul>
              </div>
            ),
          },
        ...
        relatedGuides={[
          { title: 'Document Water Damage for Insurance', href: '/guides/insurance/document-water-damage-insurance', description: 'Step-by-step guide to photographing and documenting water damage for your claim.' },
          { title: 'Should I Take a Payout?', href: '/guides/insurance/should-i-take-a-payout', description: 'Cash settlement vs managed repairs — which option is better for your situation?' },
          { title: 'Insurance Depreciation on Water Damage', href: '/guides/insurance/insurance-depreciation-water-damage', description: 'How depreciation affects your payout and strategies to maximise your settlement.' },
          { title: 'When Your Insurer Delays Your Claim', href: '/guides/insurance/insurer-delays-your-claim', description: 'GICP timeframes and how to escalate delays to AFCA.' },
          { title: 'Emergency Water Extraction', href: '/services/emergency-water-extraction', description: 'Lodge an emergency claim for immediate professional water extraction.' },
        ]}
