...
export const metadata: Metadata = {
  title: "Your Advocate vs Your Insurer's Builder — Who Works for You? | Disaster Recovery",
  description:
    ...
    <>
      ...
      <AgGuidePageTemplate
        ...
        sections={[
          {
            ...
            body: (
              <>
                <p>
                  After a disaster — flood, fire, storm, or cyclone — your insurer activates a
                  managed repair program. In most cases, this means they assign a building or
                  restoration contractor from their preferred supplier network. On paper, this is
                  positioned as a convenience: one call, one contractor, insurer-managed.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  In practice, two fundamentally different models exist for how your property gets
                  restored:
                </p>
                <div
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <li>
                        Contractor&apos;s primary obligation is to the insurer&apos;s scope and
                        budget
                      </li>
                      <li>
                        Scope of works is set to the insurer&apos;s minimum — not necessarily the
                        full extent of damage
                      </li>
                      <li>You have limited visibility into how your property is being assessed</li>
                      <li>
                        Disputes require going through the insurer&apos;s internal review process
                        first
                      </li>
                      <li>
                        You cannot independently verify the work meets current industry standards
                        (IICRC S500:2025, S700:2025)
                      </li>
                    </ul>
                  </div>
                  <div
                  ...
                  >
                    ...
                    >
                      ...
                      <li>
                        Contractor documents the full scope of your damage, not the insurer&apos;s
                        minimum
                      </li>
                      <li>
                        IICRC S500:2025 / S700:2025 standards applied — documented for insurer
                        review
                      </li>
                      <li>Full photographic and written record produced independently</li>
                      <li>
                        Independent documentation supports AFCA complaints if claim is disputed
                      </li>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  <strong>"Who First"</strong> is not a slogan — it is a structural commitment about
                  whose interests drive every decision on your job.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  When your insurer assigns a contractor, the commercial relationship is between the
                  insurer and the contractor. The insurer pays; the contractor&apos;s scope reflects
                  the insurer&apos;s authorised budget. This is a normal commercial arrangement —
                  but it is not the same as an arrangement where the contractor&apos;s obligation
                  runs to you.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  An independent IICRC-certified contractor engaged directly by you (or documented
                  as working to your brief) produces a scope of works that reflects the full extent
                  of damage — not a pre-approved budget ceiling. That documentation matters most
                  when:
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    Your insurer&apos;s scope has missed damage items (HVAC smoke infiltration,
                    subfloor moisture, mould onset)
                  </li>
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  Under Australian Consumer Law and the General Insurance Code of Practice, you have
                  rights about how your claim is managed. While insurers can offer managed repair
                  programs, the Australian Financial Complaints Authority (AFCA) has ruled in
                  policyholders&apos; favour in cases where:
                </p>
                <ul style={{ marginTop: '0.75rem', paddingLeft: '1.5rem', lineHeight: 2 }}>
                  <li>
                    The insurer&apos;s contractor did not complete work to an acceptable standard
                    (s54 Insurance Contracts Act 1984)
                  </li>
                  <li>The scope of works did not reflect the full extent of covered damage</li>
                  <li>
                    The policyholder was not given adequate opportunity to raise concerns about
                    repair quality before the claim was closed
                  </li>
                </ul>
                <p style={{ marginTop: '1rem' }}>
                  In the IAG case published by AFCA, the insurer was required to pay an additional
                  $89,000 after the original scope was found to have significantly undervalued the
                  structural damage. An independent assessment produced by the policyholder was
                  central to the AFCA ruling.
                </p>
                <p style={{ marginTop: '1rem' }}>
                  You do not need to accept your insurer&apos;s scope as final. An independent
                  IICRC-certified assessment gives you documented grounds to request a review — or,
                  if the insurer fails to resolve it, to escalate to AFCA at no cost.
                </p>
              </>
            ),
          },
          {
            ...
            body: (
              <>
                <p>
                  AFCA publishes case determinations from insurance complaints. Recurring patterns
                  in published fire and water damage restoration cases include:
                </p>
                <div
                  style={{
                    marginTop: '1.5rem',
                  ...
                  {[
                    {
                      ...
                      outcome:
                        'AFCA ordered additional payment where independent scope documented a materially larger loss.',
                    },
                    {
                      ...
                      outcome:
                        'AFCA found insurer responsible for quality of work by its preferred contractors (s54 Insurance Contracts Act 1984). Remediation costs awarded.',
                    },
                    {
                      ...
                      outcome:
                        'AFCA has ruled that insurers cannot close claims without adequate opportunity for policyholders to identify defects. Documentation of incomplete work is key evidence.',
                    },
                  ].map((item) => (
                    <div
                      key={item.issue}
                    ...
                    >
                      ...
                      <p style={{ fontSize: '0.85rem', color: '#059669', fontWeight: 500 }}>
                        Outcome pattern: {item.outcome}
                      </p>
                    </div>
                  ))}
                </div>
                <p style={{ marginTop: '1.5rem', fontSize: '0.85rem', color: '#6B7280' }}>
                  These patterns are drawn from published AFCA determinations. Individual case
                  outcomes vary. Source:{' '}
                  <a
          ...
          },
          {
            ...
            body: (
              <>
                <p>
                  If you have concerns about how your insurer is managing your restoration claim,
                  follow these steps in order:
                </p>
                <ol style={{ marginTop: '1rem', paddingLeft: '1.5rem', lineHeight: 2.5 }}>
                  <li>
                    <strong>Get an independent IICRC-certified assessment</strong> — Document the
                    full scope of damage to IICRC S500:2025 or S700:2025 standard before the insurer
                    closes your claim. This is your most important piece of evidence.
                  </li>
                  <li>
                    <strong>Compare the independent scope to the insurer&apos;s scope</strong> —
                    Identify items that appear in the independent assessment but not the
                    insurer&apos;s approved scope. These are the items to dispute.
                  </li>
                  <li>
                    <strong>Lodge an internal dispute with your insurer</strong> — All Australian
                    insurers must have an internal dispute resolution (IDR) process. Request a
                    formal review in writing, attaching the independent assessment.
                  </li>
                  <li>
                    <strong>Escalate to AFCA if unresolved within 30 days</strong> — AFCA accepts
                    complaints at no cost to policyholders. The complaint must generally be lodged
                    within 2 years of the insurer&apos;s decision.
                  </li>
                </ol>
        ...
        faqs={[
          ...
          {
            question: 'Does "Who First" mean Disaster Recovery argues my insurance claim for me?',
            answer:
              'Disaster Recovery is a restoration network — our IICRC-certified contractors restore your property. We do not act as claim advocates or insurance advisors. "Who First" means that our contractor\'s scope documents your loss in full, to the current IICRC standard, independently of your insurer\'s authorised budget. That independent documentation is what you use to support any dispute process.',
          },
          {
        ...
        relatedGuides={[
          {
            title: 'IICRC S700:2025 Fire & Smoke Restoration Standard',
