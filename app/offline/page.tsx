...
export const metadata: Metadata = {
  title: 'Offline | Disaster Recovery',
  description:
    'Offline life-safety shell. Call 000 in an emergency, or 1300 309 361 to speak to Disaster Recovery.',
    ...
    <main className="min-h-screen bg-white px-6 py-10 flex flex-col items-center">
      <div className="w-full max-w-xl">
        ...
        <div className="text-center mb-6">
          ...
          <p className="mt-3 text-lg font-bold text-blue-900">Disaster Recovery</p>
        </div>
        ...
        >
          <p className="text-sm font-semibold text-amber-900">You appear to be offline.</p>
          <p className="mt-1 text-xs text-amber-900 leading-relaxed">
            Your safety comes first — call the numbers below if you are in danger. This page works
        ...
        <div role="alert" className="mb-6 rounded-lg border-2 border-red-600 bg-red-50 p-4">
          ...
          <p className="mt-2 text-xs text-red-900 leading-relaxed">
            ...
            call 000 first. You can lodge the claim once you are safe.
          </p>
        </div>

        {/* DR-542 — Prefer-to-call fallback. Same canonical number as /claim. */}
        <div className="mb-6 rounded-lg border border-blue-200 bg-blue-50 p-4">
          <p className="text-sm font-semibold text-blue-900 mb-1">Prefer to talk to a person?</p>
        ...
        >
          <p className="font-semibold text-slate-900 mb-1">How we handle your information</p>
          <p>
            National Restoration Professionals Group Pty Ltd (ABN 85 151 794 142), trading as
            Disaster Recovery, collects personal information only to triage your claim, dispatch an
            IICRC-certified contractor, and meet our legal obligations.
          </p>
          <p className="mt-2">
            We collect under the Privacy Act 1988 (Cth) and the Australian Privacy Principles. You
            may access, correct, or complain about the handling of your information at any time —
            see our Privacy Policy once you are back online.
          </p>
          <p className="mt-2 text-slate-500">Not legal advice.</p>
        </section>
