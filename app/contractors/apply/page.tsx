...
export const metadata: Metadata = {
  title: 'Apply to Join the NRPG Contractor Network | Disaster Recovery',
  description:
    "Apply to join Australia's premier disaster recovery contractor network. IICRC certification required. Get qualified leads in your territory.",
};
      ...
      sections={[
        {
          ...
          body: (
            <p className="text-sm text-slate-500 leading-relaxed">
              By submitting an application, you consent to Disaster Recovery collecting your
              business and personal information to assess your application for the NRPG contractor
              network. Handled in accordance with the{' '}
