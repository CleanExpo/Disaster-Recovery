...
export const metadata: Metadata = {
  title: 'Fuel Surcharge Pricing Guide 2026 — Restoration & Carpet Cleaning | Disaster Recovery',
  description:
...
const articleSchema = {
  ...
  author: { '@type': 'Organization', name: 'Disaster Recovery / NRPG' },
  publisher: {
    '@type': 'Organization',
        ...
        <section className="bg-slate-900 text-white py-16 md:py-24 print:py-8 print:bg-white print:text-black">
          <div className="container mx-auto px-6 max-w-4xl">
            ...
            <p className="text-xl text-slate-300 max-w-2xl mb-8 print:text-black print:text-base">
              Small, medium, and large operations navigating the 2026 Strait of Hormuz energy
              crisis. Fair pricing formulas, ACCC compliance, and invoice implementation — no fluff.
            </p>
        ...
        <article className="container mx-auto px-6 max-w-4xl py-12 print:py-4">
          ...
          <section id="crisis" className="mb-14">
            ...
            <p className="text-slate-700 mb-4">
              ...
              Approximately 20% of global oil supply transits the Strait. Its closure sent Brent
              crude surging from ~$78/barrel to a peak of $126/barrel — a 60%+ increase in under
              four weeks.
            </p>
            <p className="text-slate-700 mb-6">
              For Australia, 70–80% of our refined petrol and diesel arrives via Asian refineries
              dependent on Hormuz transit routes. The Australian Government halved the fuel excise
              from 52.6c/L to 26.3c/L from 1 April to 30 June 2026 — providing some relief, but not
              fully offsetting the 40–60% increase in underlying fuel costs.
            </p>
            ...
            <p className="text-xs text-slate-500">
              Sources: GlobalPetrolPrices.com, NRMA Weekly Fuel Report, IEA 2026 Energy Crisis
              Tracker, US EIA
            </p>
          </section>
          ...
          <section id="impact" className="mb-14">
            ...
            <p className="text-slate-700 mb-6">
              Fuel is a disproportionate cost for mobile service businesses. Every job requires
              driving to site — often with heavy equipment. Diesel powers the vans, truck-mounted
              extractors, trailer dehumidifiers, and generators. With diesel approaching $3.00/L (up
              from ~$1.85/L pre-crisis), a single van running 150km/day costs an additional
              $15–$25/day in fuel alone.
            </p>
          ...
          <section id="global" className="mb-14">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-blue-50 rounded-lg p-5 border border-blue-100">
                ...
                <ul className="space-y-2 text-sm text-slate-700">
                  <li>
                    <strong>USPS:</strong> 8% fuel surcharge on packages (March 2026)
                  </li>
                  <li>
                    <strong>Amazon:</strong> 3.5% fuel and logistics surcharge
                  </li>
                  <li>
                    <strong>HVAC/Plumbing:</strong> $10–$15 flat per service call
                  </li>
                  <li>
                    <strong>Pest control:</strong> 3–5% surcharge on invoices, monthly review
                  </li>
                  <li>
                    <strong>Construction:</strong> 8–10% surcharges now standard
                  </li>
                </ul>
              </div>
              <div className="bg-green-50 rounded-lg p-5 border border-green-100">
                ...
                <ul className="space-y-2 text-sm text-slate-700">
                  <li>
                    <strong>Concrete suppliers:</strong> $8.10–$8.67 per m³ surcharge
                  </li>
                  <li>
                    <strong>Construction:</strong> 8–10% fuel surcharges on projects
                  </li>
                  <li>
                    <strong>Logistics/freight:</strong> Variable, tied to weekly diesel index
                  </li>
                  <li>
                    <strong>ACCC position:</strong> Actively monitoring — surcharges must be
                    justified by actual cost increases
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-5">
              ...
              <p className="text-sm text-slate-700">
                ...
                <strong>Camp 1</strong> added a visible fuel surcharge as a separate line item
                ($10–$15/call). <strong>Camp 2</strong> quietly raised base rates by 5–8%. When
                prices dropped, Camp 1 could visibly <em>remove</em> the surcharge — generating
                client goodwill. Camp 2 never lowered rates back down, creating silent resentment.
              </p>
              <p className="text-sm font-semibold text-slate-800 mt-2">
                Use a visible, separate line-item surcharge. It aligns with NRPG's "Who First"
                philosophy — transparency with the people you serve.
              </p>
            </div>
          </section>
          ...
          <section id="pricing" className="mb-14">
            ...
            <div className="bg-slate-800 text-white rounded-lg p-6 mb-6 font-mono text-sm">
              ...
              <div className="mt-3 space-y-1 text-slate-300">
                <p>
                  • <strong className="text-white">Baseline:</strong> price/litre when you last set
                  your rates (~$1.85/L diesel pre-crisis)
                </p>
                <p>
                  • <strong className="text-white">Current:</strong> this week's average diesel at
                  your local station (check AIP or NRMA)
                </p>
                <p>
                  • <strong className="text-white">Avg litres:</strong> total litres used per week ÷
                  total jobs per week (travel + equipment run time)
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 mb-6">
              {[
                ...
                <div key={size} className={`rounded-lg p-5 border ${bg}`}>
                  ...
                  <p className="text-sm font-semibold text-slate-800 bg-white/60 rounded px-3 py-2">
                    ✓ {recommendation}
                  </p>
                </div>
              ))}
                  ...
                  {[
                    ...
                    <tr key={row[0]} className="hover:bg-slate-50">
                      {row.map((cell, i) => (
                        <td
                          key={i}
                          className={`px-4 py-3 ${i === 0 ? 'font-medium text-slate-700' : 'text-center text-slate-600'}`}
                        >
                          {cell}
                        </td>
                      ))}
          ...
          <section id="implementation" className="mb-14">
            ...
            <div className="space-y-4 mb-8">
              {[
                ...
                <div
                  key={title}
                  className="flex gap-4 p-5 rounded-lg bg-slate-50 border border-slate-200"
                >
            ...
            <div className="rounded-lg border border-slate-200 overflow-hidden">
              ...
              <div className="bg-slate-50 px-4 py-3 text-xs text-slate-500 border-t border-slate-200">
                *Temporary Fuel Surcharge: Applied due to the current global fuel crisis (Strait of
                Hormuz disruption). Tied to the AIP national diesel average. Reviewed monthly. Will
                be removed when diesel returns below $2.20/L.
              </div>
            </div>
          </section>
          ...
          <section id="accc" className="mb-14">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-5 mb-6">
              ...
              <p className="text-sm text-red-700">
                Several businesses have already been served notices requiring them to justify
                surcharges, particularly those exceeding 70% in remote areas.
              </p>
            </div>
            <div className="space-y-3">
              {[
                [
                  'Your surcharge must reflect actual cost increases',
                  'Keep fuel receipts and log your weekly average price. The surcharge must be defensible against your real data.',
                ],
                [
                  'Do not bundle surcharges with hidden fees',
                  'The surcharge must be a visible, separate charge. Bundling creates a risk of misleading conduct under the Australian Consumer Law.',
                ],
                [
                  'Disclose before the service is provided',
                  'Under ACL, consumers must be informed of all charges before committing to a purchase. Mention it during quoting, on your website, and in booking confirmations.',
                ],
                [
                  'Review and adjust regularly',
                  'A surcharge set in April that is still the same amount in September (when fuel may have dropped) looks like profiteering. Review monthly at minimum.',
                ],
                [
                  'Keep a surcharge policy document',
                  'Write down your baseline price, your formula, your review schedule, and your removal trigger. If the ACCC asks, you have documentation.',
                ],
              ].map(([title, body]) => (
              ...
              {faqSchema.mainEntity.map((item) => (
                ...
                >
                  <summary className="flex items-center justify-between px-5 py-4 cursor-pointer font-semibold text-slate-800 hover:bg-slate-50 list-none">
                    {item.name}
                    <span className="text-slate-400 ml-4 flex-shrink-0 group-open:rotate-180 transition-transform">
                      ▾
                    </span>
                  </summary>
          ...
          <div className="bg-slate-900 text-white rounded-xl p-8 mb-10">
            ...
            <p className="text-slate-300 mb-4">
              A fair fuel surcharge for carpet cleaning and restoration firms in the current crisis
              sits between <strong className="text-white">$5–$10 per residential job</strong> or{' '}
              <strong className="text-white">2–5% of invoice value</strong> for
              commercial/restoration work, capped at $50–$75 for large jobs. This is defensible,
              proportionate to actual cost increases, and aligned with what major industries are
              charging (USPS at 8%, Amazon at 3.5%, construction at 8–10%).
            </p>
            <p className="text-slate-300">
              The key to avoiding backlash is <strong className="text-white">transparency</strong>.
              Name it clearly. Show it separately. Tie it to a public index. Remove it the moment
              you can. That&apos;s how you pass on costs without losing trust — and it&apos;s
              exactly what &quot;Who First&quot; looks like in practice.
            </p>
          </div>
          ...
          <div className="text-xs text-slate-500 border-t border-slate-200 pt-6 mb-10">
            ...
            <p>
              IEA 2026 Energy Crisis Policy Response Tracker · GlobalPetrolPrices.com Australia
              Diesel Prices (6 Apr 2026) · NRMA Weekly Fuel Report (Apr 2026) · ACCC Fuel Excise Cut
              Monitoring (Apr 2026) · Australian Government Fuel Excise Relief Fact Sheet (1 Apr
              2026) · ATO Fuel Tax Credits 2025–26 · CNN Business Fuel Surcharge Report (7 Apr 2026)
              · CNBC Amazon Surcharge Report (2 Apr 2026) · IBTimes Australia Fuel Crisis 2026
            </p>
          </div>
          ...
          <div className="bg-red-700 text-white rounded-xl p-8 text-center print:hidden">
            ...
            <p className="text-red-100 mb-6 max-w-xl mx-auto">
              NRPG contractors provide insurance-standard documentation — including itemised
              surcharges — to support your claim from first contact through to settlement.
            </p>
