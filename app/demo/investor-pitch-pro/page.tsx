...
// D5 perf: lazy-loaded motion runtime — `m` replaces `motion`; LazyMotion wraps the page.
import {
  LazyMotion,
  domAnimation,
  m,
...
const professionalSlides = [
  {
    ...
    speakerNotes:
      "Emphasize the scale of the opportunity and our unique position as a technology platform, not a service provider. Highlight that we're building infrastructure, not just another restoration company.",
  },
  {
    id: 2,
    chapter: 'Problem',
      ...
      problems: [
        {
          issue: 'Admin Control',
          stat: 'Major',
          description: 'Market controlled by middlemen taking huge cuts',
        },
        {
          issue: 'Resolution Time',
          stat: '6-12mo',
          description: 'Average claim resolution period',
        },
        {
          issue: 'Fragmentation',
          stat: '115,350',
          description: 'Contractors with no unified platform',
        },
    ...
    duration: 11000,
    narration:
      'The Australian restoration industry is fundamentally broken. Admin companies dominate the market, taking massive cuts while customers wait 6 to 12 months for resolution. With 115,350 fragmented contractors and only 2% digital adoption, the industry desperately needs disruption. This inefficiency costs insurers billions and leaves communities devastated.',
    speakerNotes:
      'Paint a vivid picture of the problem. Use specific examples if asked - mention recent floods, bushfires. This slide sets up the need for our solution.',
  },
  {
    id: 3,
    chapter: 'Solution',
    ...
    speakerNotes:
      "Emphasize automation and scale. Make clear we're a tech platform, not a service provider. This is Uber for disaster recovery.",
  },
  {
    id: 4,
    chapter: 'Market',
    ...
    speakerNotes:
      "Show the inevitability of growth. Climate change isn't going away. Insurance companies need our solution to stay profitable.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    speakerNotes:
      "This is a key differentiator - the platform exists and works. We're not asking for money to build, but to scale.",
  },
  {
    id: 7,
    chapter: 'Technology',
    ...
    duration: 10000,
    narration:
      "Our technology creates an unbeatable moat. We use GPT-4 for intelligent fraud detection and contractor matching. Our SEO engine can generate 30,000 location-specific pages automatically. Stripe Connect handles complex payment splitting, while our IICRC compliance system ensures quality. We're 18 to 24 months ahead of any potential competitor.",
    speakerNotes:
      "Emphasize the sophistication and barriers to entry. This isn't just a website - it's complex infrastructure.",
  },
  {
    id: 8,
    ...
    speakerNotes:
      'Show the systematic approach to market domination. Emphasize first-mover advantage and network effects.',
  },
  {
    id: 9,
    chapter: 'Financials',
  ...
  },
  {
    ...
    speakerNotes:
      "Emphasize urgency - this opportunity won't last. Someone will build this. It should be us.",
  },
  {
    id: 11,
...
function InvestorPitchProPage() {
  ...
  const handleDownload = () => {
    const content = professionalSlides
      .map(
        (slide, index) =>
                ...
                >
                  <div className="text-4xl font-bold">
                    <AnimatedCounter
                      ...
                      suffix={
                        metric.value.includes('B') ? 'B' : metric.value.includes('M') ? 'M' : ''
                      }
                    />
                  </div>
    ...
    <LazyMotion features={domAnimation} strict>
      <div className="min-h-screen bg-black relative overflow-hidden" ref={containerRef}>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="max-w-7xl w-full">{renderSlideContent()}</div>
          </m.div>
        </AnimatePresence>
          ...
          <div className="px-6 py-4">
            ...
            <div className="mb-4">
              <div className="flex items-center justify-between text-xs text-gray-200 mb-2">
                ...
                <span>
                  Slide {currentSlide + 1} of {professionalSlides.length}
                </span>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <button
                  onClick={() =>
                    currentSlide < professionalSlides.length - 1 &&
                    setCurrentSlide((prev) => prev + 1)
                  }
        ...
        <AnimatePresence>
          {showNotes && (
            ...
            >
              ...
              <p className="text-gray-300 text-sm leading-relaxed">{slide.speakerNotes}</p>
            </m.div>
          )}
        </AnimatePresence>
