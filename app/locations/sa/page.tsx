...
const localBusinessSchema = {
  ...
  name: 'Disaster Recovery Australia — South Australia',
  ...
  areaServed: [
    ...
    { '@type': 'City', name: 'Gawler', containedInPlace: { '@type': 'State', name: 'South Australia' } },
    { '@type': 'City', name: 'Mount Gambier', containedInPlace: { '@type': 'State', name: 'South Australia' } },
    { '@type': 'City', name: 'Murray Bridge', containedInPlace: { '@type': 'State', name: 'South Australia' } },
    { '@type': 'City', name: 'Port Augusta', containedInPlace: { '@type': 'State', name: 'South Australia' } },
    { '@type': 'City', name: 'Port Lincoln', containedInPlace: { '@type': 'State', name: 'South Australia' } },
    { '@type': 'City', name: 'Whyalla', containedInPlace: { '@type': 'State', name: 'South Australia' } },
  ],
  address: {
    '@type': 'PostalAddress',
    addressRegion: 'SA',
...
const sections = [
    ...
    body: (
      <div>
        <p style={{ marginBottom: '1rem', lineHeight: 1.8 }}>
          ...
          heat, and storm damage. The Adelaide Hills and Mount Lofty Ranges carry high bushfire
          risk from November through March. The Eyre Peninsula and South East experience periodic
          flooding and storm surge. Adelaide itself is exposed to severe thunderstorm cells
          bringing hail, lightning, and short-duration flash flooding. Extended drought and heat
          conditions drive building movement, roof damage, and mould after even minor water
          intrusion.
        </p>
        <ul style={{ paddingLeft: '1.5rem', lineHeight: 2 }}>
          <li>Bushfire and ember attack — Adelaide Hills, Mount Lofty Ranges, and Eyre Peninsula</li>
  ...
  },
  {
    ...
    body: (
      <div>
        <p style={{ marginBottom: '1rem', lineHeight: 1.8 }}>
          Following declared disaster events in South Australia, assistance programs operate
          through the Department for Disaster and Emergency Services (DDES) and the Commonwealth
          Disaster Recovery Allowance scheme.
        </p>
    ...
    body: (
      <div>
        <ol style={{ paddingLeft: '1.5rem', lineHeight: 2.2 }}>
          ...
          <li><strong>Document all damage</strong> before any clean-up — photos, video, and written notes covering all affected areas.</li>
