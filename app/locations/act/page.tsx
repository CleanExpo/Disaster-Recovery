...
export const metadata: Metadata = {
  ...
  description:
    'Leading disaster recovery services in the Australian Capital Territory. Emergency response for bushfires, storms, hail, frost damage. Serving Canberra, Belconnen, Tuggeranong, Gungahlin and all ACT regions.',
  keywords: [
    ...
    ...['Sydney', 'Melbourne', 'Brisbane'].map(
      (city: string) => `${city.toLowerCase()} disaster recovery`,
    ),
  ...
  return (
    <AgContentPageTemplate
      hero={{
        ...
        title: 'Disaster Recoveryn Capital Territory',
