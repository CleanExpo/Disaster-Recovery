...
const localBusinessSchema = {
  ...
  name: 'Disaster Recovery Australia — Queensland',
  ...
  areaServed: [
    ...
    { '@type': 'City', name: 'Rockhampton', containedInPlace: { '@type': 'State', name: 'Queensland' } },
    { '@type': 'City', name: 'Toowoomba', containedInPlace: { '@type': 'State', name: 'Queensland' } },
  ],
  address: {
    '@type': 'PostalAddress',
    addressRegion: 'QLD',
    ...
    body: (
      <div>
        <p style={{ marginBottom: '1rem', lineHeight: 1.8 }}>
          Queensland carries the highest annual disaster risk profile of any Australian state.
          The tropical north faces cyclone season from November through April, bringing sustained
          winds, storm surge, and rainfall events that can exceed 600mm in 24 hours.
          South-east Queensland experiences severe storm cells, flash flooding, and hail damage
          year-round. Elevated humidity drives mould growth within 24–48 hours of a water
          intrusion event — faster than in any other state.
        </p>
    ...
    body: (
      <div>
        <p style={{ marginBottom: '1rem', lineHeight: 1.8 }}>
          ...
          Queensland Reconstruction Authority (QRA) and the Commonwealth Disaster Recovery
          Allowance scheme.
        </p>
        <div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))' }}>
          ...
          <div style={{ background: 'white', borderRadius: '0.75rem', padding: '1.25rem', border: '1px solid rgba(0,0,0,0.08)' }}>
            ...
            <p style={{ fontSize: '0.9rem', lineHeight: 1.7, margin: 0 }}>
              The Australian Reinsurance Pool Corporation pool holds more than $1 billion in
              cyclone reinsurance capacity. Your insurer is required to pass premium savings to
    ...
    body: (
      <div>
        <ol style={{ paddingLeft: '1.5rem', lineHeight: 2.2 }}>
          ...
          <li><strong>Document all damage</strong> before any clean-up — photos and video, including hidden areas like roof cavities and subfloor.</li>
          <li><strong>Contact your insurer</strong> to notify them of the event — but do not accept a cash settlement until damage is fully assessed.</li>
          <li><strong>Prevent further damage</strong> only as far as is safe — temporary roof tarps, water extraction — keep all receipts for these costs as they are claimable.</li>
    ...
    <>
      ...
      <AgContentPageTemplate
        ...
        relatedPages={[
          ...
          { title: 'How Claims Work', href: '/guides/how-insurance-claims-work-australia', description: 'Step-by-step guide to lodging and managing a property insurance claim in Australia.' },
        ]}
      />
    </>
  );
