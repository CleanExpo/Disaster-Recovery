          ...
          body: (
            <div className="space-y-3 text-sm text-slate-700">
              <p>
                ...
                (ABN 53 662 478 408). Equipped holds the relevant Australian Credit Licence or acts as
                an authorised credit representative, and is a member of the Australian Financial
                Complaints Authority (AFCA). Licensing and membership numbers are stated in
                Equipped&apos;s Credit Guide, linked below.
              </p>
