  ...
  const practicalExercises = [
    {
      ...
      scenario:
        'You arrive at a home with water throughout the ground floor. The customer says their washing machine hose burst 3 days ago while they were on holiday.',
      tasks: [
    ...
    },
    {
      ...
      scenario:
        'Create a moisture map for a 15m x 10m commercial space with water damage affecting 60% of the area.',
      tasks: [
        'Draw the floor plan',
            ...
            <Card>
              ...
              <CardContent>
                <Tabs
                  ...
                  onValueChange={(v) => setSelectedCategory(v as 'cat1' | 'cat2' | 'cat3')}
                >
                ...
                <Tabs defaultValue="equipment">
                  ...
                  <TabsContent value="standards" className="mt-4">
                    <Card>
                      ...
                      <CardContent>
                        <div className="space-y-3">
                          {Object.entries(modules[1].content.moistureMapping.dryStandard).map(
                            ([material, standard]) => (
                              <div
                                key={material}
