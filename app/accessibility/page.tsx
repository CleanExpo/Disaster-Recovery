...
export const metadata: Metadata = {
  ...
  description:
    'Our commitment to digital accessibility. Disaster Recovery strives to ensure our website is accessible to all users, including those with disabilities.',
  alternates: {
      ...
      sections={[
        {
          ...
          body: (
            <>
              <p>
                Disaster Recovery is committed to ensuring digital accessibility for people with
        ...
        },
        {
          ...
          body: (
            <>
              <p>
                We recognise that during an emergency, accessibility is critical. Our claim
                submission system is designed to be usable by assistive technologies, and our 24/7
                service ensures help is available to all Australians regardless of ability.
              </p>
              <p style={{ marginTop: '1rem' }}>
                If you are experiencing a property emergency and have difficulty using our website,
                please use our contact form at{' '}
                <a
                  href="/contact"
                  style={{ color: 'var(--ag-secondary-blue)', textDecoration: 'underline' }}
                >
                  /contact
                </a>{' '}
        ...
        },
        {
          ...
          body: (
            <>
              <p>
                We welcome your feedback on the accessibility of the Disaster Recovery website. If
                you encounter any accessibility barriers or have suggestions for improvement, please
                contact us:
              </p>
              <ul
                style={{
