...
export const metadata: Metadata = {
  ...
  description:
    'Emergency disaster recovery services available All Australian Holidays. No call-out fees, rapid response nationwide.',
  ...
  return (
    <AgContentPageTemplate
      ...
      sections={getEmergencySections({
        ...
        context: 'on all Australian public holidays',
      })}
