...
export const metadata: Metadata = {
  ...
  description:
    'Emergency disaster recovery services available 10PM - 2AM. No call-out fees, rapid response nationwide.',
  ...
  return (
    <AgContentPageTemplate
      ...
      sections={getEmergencySections({
        emergencyType: 'Late Night',
        context: 'late at night including after midnight',
      })}
