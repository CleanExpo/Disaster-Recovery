...
export const metadata: Metadata = {
  ...
  description:
    'Emergency disaster recovery services available 4AM - 7AM. No call-out fees, rapid response nationwide.',
  ...
  return (
    <AgContentPageTemplate
      ...
      sections={getEmergencySections({
        emergencyType: 'Early Morning',
        context: 'from 5AM including early starts',
      })}
