...
export const metadata: Metadata = {
  ...
  description:
    'Step-by-step emergency response checklists for water damage, fire, storm, mould, and sewage disasters. Protect life, property, and ensure proper insurance documentation.',
  keywords: [
    'emergency checklist',
    'disaster response checklist',
    'water damage checklist',
    'fire damage steps',
    'storm damage checklist Australia',
  ],
  ...
  return (
    <AgContentPageTemplate
      ...
      sections={getEmergencySections({
        emergencyType: 'Emergency Checklist',
        context: 'for all types of property disasters',
      })}
