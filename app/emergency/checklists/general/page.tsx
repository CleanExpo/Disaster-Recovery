...
export const metadata: Metadata = {
  ...
  description:
    'Universal disaster response checklist for any emergency. Safety actions, documentation, insurance notification, and professional restoration steps for property owners.',
  alternates: {
  ...
  return (
    <AgContentPageTemplate
      hero={{
        ...
        subtitle:
          'A general-purpose emergency checklist for any property disaster. Safety first, then documentation, insurance notification, and professional restoration.',
      }}
      ...
      sections={getEmergencySections({
        emergencyType: 'General Emergency Checklist',
        context: 'for any disaster situation',
      })}
