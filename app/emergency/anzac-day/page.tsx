...
export const metadata: Metadata = {
  ...
  description:
    'Emergency disaster recovery services available April 25. No call-out fees, rapid response nationwide.',
  ...
  return (
    <AgContentPageTemplate
      ...
      sections={getEmergencySections({
        emergencyType: 'ANZAC Day',
        context: 'on public holidays including ANZAC Day',
      })}
