...
export const metadata: Metadata = {
  ...
  description:
    'Terms of Service for Disaster Recovery Australia. Conditions of use for emergency restoration matching services across Australia and New Zealand.',
  alternates: {
    canonical: 'https://disasterrecovery.com.au/terms',
  },
  openGraph: {
    title: 'Terms of Service | Disaster Recovery Australia',
    description: 'Terms and conditions for Disaster Recovery Australia restoration matching services.',
    type: 'website',
  },
};
...
export default function TermsOfService() {
  return (
    <AgGuidePageTemplate
      ...
      subtitle={`Conditions of use for the Disaster Recovery Australia platform. Last updated ${LAST_UPDATED}.`}
      ...
      sections={[
        {
          ...
          body: (
            <>
              <p>
                These Terms of Service govern your use of the Disaster Recovery Australia platform operated by National Restoration Professionals Group Pty Ltd (ABN 85 151 794 142) trading as Disaster Recovery Australia (<em>&quot;we&quot;</em>, <em>&quot;us&quot;</em>, <em>&quot;our&quot;</em>).
              </p>
        ...
        },
        {
          ...
          body: (
            <>
              ...
              <p style={{ marginTop: '1rem' }}>
                <strong>Consumer rights.</strong> Nothing in our terms excludes, restricts, or modifies any right or remedy you have under the Consumer Guarantees Act 1993 (CGA), the Fair Trading Act 1986 (FTA), or the Privacy Act 2020, where those statutes apply to the supply of our services to you.
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Services guarantees.</strong> Where services are supplied to a New Zealand consumer, those services come with guarantees that cannot be excluded under the CGA, including reasonable care and skill (s28), fitness for particular purpose (s29), completion within a reasonable time (s30), and supply at a reasonable price where no price is fixed (s31).
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Goods guarantees.</strong> Where goods form part of the supply, those goods come with guarantees under the CGA including acceptable quality (s6), fitness for particular purpose (s8), correspondence with description (s9), and correspondence with sample (s10).
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Fair Trading Act.</strong> We will not engage in misleading or deceptive conduct, make false or misleading representations, or engage in unsubstantiated representations in breach of the FTA. If a statement on our website or marketing is inaccurate in relation to services to be supplied in New Zealand, please notify us and we will correct it.
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Business customers.</strong> If you are acquiring our services for the purposes of a business, you and we agree that the CGA and sections 9, 12A, 13, and 14(1) of the FTA do not apply to the extent permitted by section 43 of the CGA and section 5D of the FTA, and it is fair and reasonable for the parties to be bound by that arrangement.
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Privacy.</strong> We collect, hold, use and disclose personal information in accordance with the Privacy Act 2020. See our <Link href="/privacy" style={{ color: '#1D4ED8', textDecoration: 'underline' }}>Privacy Policy</Link>. By submitting a claim you acknowledge that your personal information may be transferred to Australia and disclosed to contractors, insurers, and service providers necessary to fulfil your claim. You may lodge a complaint with the Office of the Privacy Commissioner at <a href="https://www.privacy.org.nz" target="_blank" rel="noopener noreferrer" style={{ color: '#1D4ED8', textDecoration: 'underline' }}>privacy.org.nz</a>.
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Dispute resolution.</strong> If we cannot resolve a complaint, you may refer the dispute to the Disputes Tribunal of New Zealand (claims up to NZD 30,000), the District Court of New Zealand, or the Commerce Commission (for FTA matters). Nothing in the main terms requiring arbitration or referral to an Australian forum limits your right to access a New Zealand court or tribunal where New Zealand law gives you that right.
              </p>
              <p style={{ marginTop: '1rem' }}>
                <strong>Governing law for NZ consumers.</strong> The main terms are governed by the laws of Queensland, Australia. For New Zealand consumers, the non-excludable rights and remedies under the CGA, FTA, and Privacy Act 2020 continue to apply regardless of that choice of law.
              </p>
            </>
          ),
        },
