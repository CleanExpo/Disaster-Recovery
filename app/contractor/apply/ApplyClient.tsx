...
function ContractorApplicationContent() {
  ...
  const saveProgress = async () => {
    ...
    // Save to localStorage — draft persists for same browser session
    localStorage.setItem('contractor_onboarding_progress', JSON.stringify(progress));
    // Server-side draft persistence deferred: requires /api/contractor/onboarding/save-progress endpoint
