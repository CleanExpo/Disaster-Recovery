# Disaster Recovery — AI Front Desk (scaffold)
...
Disaster Recovery's instance of the portfolio **AI Front Desk** — a single agent "brain"
...
- **This desk's job:** 24/7 emergency intake and dispatch — capture the loss, triage urgency, dispatch a crew, confirm by SMS. The strongest inbound-phone case in the portfolio.
- **Lead channel:** inbound phone (24/7)
- **Stack it plugs into:** Next.js 15 · Prisma · Supabase · Stripe · AI SDK
...
3. Set `DR_FRONT_DESK_ENABLED=true` in the environment to enable; unset/false = fully dark.
